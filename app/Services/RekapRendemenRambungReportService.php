...
class RekapRendemenRambungReportService
{
    ...
    public function healthCheck(string $year, string $month): array
    {
        ...
        $expectedColumns = config('reports.rekap_rendemen_rambung.expected_columns', []);
    ...
    {
        $configKey = 'reports.rekap_rendemen_rambung';
        ...
        if ($syntax === 'query') {
            $query = is_string($customQuery) && trim($customQuery) !== ''
                ? $customQuery
                : throw new RuntimeException('Query manual laporan rekap rendemen rambung belum diisi.');
