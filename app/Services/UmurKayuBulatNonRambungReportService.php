...
class UmurKayuBulatNonRambungReportService
{
    /**
    ...
    public function healthCheck(string $startDate, string $endDate): array
    {
        ...
        $expectedColumns = config('reports.umur_kayu_bulat_non_rambung.expected_columns', []);
    ...
    {
        $connectionName = config('reports.umur_kayu_bulat_non_rambung.database_connection');
        $procedure = (string) config('reports.umur_kayu_bulat_non_rambung.stored_procedure', 'SPWps_LapUmurKayuBulat');
        $syntax = (string) config('reports.umur_kayu_bulat_non_rambung.call_syntax', 'exec');
