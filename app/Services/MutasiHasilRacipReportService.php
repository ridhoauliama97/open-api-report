...
class MutasiHasilRacipReportService
{
    /**
    ...
    public function healthCheck(string $startDate, string $endDate): array
    {
        ...
        $expectedColumns = config('reports.mutasi_hasil_racip.expected_columns', []);
    ...
    {
        $connectionName = config('reports.mutasi_hasil_racip.database_connection');
        $procedure = (string) config('reports.mutasi_hasil_racip.stored_procedure');
