...
class RekapProduksiPackingPerJenisPerGradeReportService
{
    /**
    ...
    public function fetch(string $startDate, string $endDate): array
    {
        ...
        $normalized = array_map(function ($row): array {
            ...
            return [
                ...
                'InSanding' => $this->toFloat($item['Sanding'] ?? $item['InSanding'] ?? null),
                'InWIP' => $this->toFloat($item['WIP'] ?? $item['InWIP'] ?? null),
                'InBarangJadi' => $this->toFloat($item['BarangJadi'] ?? $item['InBarangJadi'] ?? null),
    ...
    {
        $connectionName = config('reports.rekap_produksi_packing_per_jenis_per_grade.database_connection');
        $procedure = (string) config(
            'reports.rekap_produksi_packing_per_jenis_per_grade.stored_procedure',
            'SP_LapRekapProduksiBarangJadiPerJenisPerGrade',
        );
        $syntax = (string) config('reports.rekap_produksi_packing_per_jenis_per_grade.call_syntax', 'exec');
