...
class TimelineKayuBulatBulananKgReportService
{
    /**
    ...
    public function healthCheck(string $startDate, string $endDate): array
    {
        ...
        $expectedColumns = config('reports.timeline_kayu_bulat_bulanan_kg.expected_columns', []);
    ...
    {
        $configKey = 'reports.timeline_kayu_bulat_bulanan_kg';
        $connectionName = config("{$configKey}.database_connection");
        $procedure = (string) config("{$configKey}.stored_procedure", 'SP_LapTimelineKBBulananKG');
