...
class RekapProduksiCrossCutAkhirPerJenisPerGradeReportService
{
    /**
    ...
    {
        $connectionName = config('reports.rekap_produksi_cross_cut_akhir_per_jenis_per_grade.database_connection');
        $procedure = (string) config(
            'reports.rekap_produksi_cross_cut_akhir_per_jenis_per_grade.stored_procedure',
            'SP_LapRekapProduksiCCAkhirPerJenisPerGrade',
        );
        $syntax = (string) config('reports.rekap_produksi_cross_cut_akhir_per_jenis_per_grade.call_syntax', 'exec');
