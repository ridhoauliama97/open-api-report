...
class KehadiranKruRacipReportService
{
    private const TITLE = 'Laporan Kehadiran Kru Racip Dorong Dan Kru Racip Sambut';

    private const TARGET_JOB_TITLE = 'OPERATOR BORONGAN SAWMILL';

    private const TARGET_WORKGROUP = 'BORONGAN SAWMILL';
