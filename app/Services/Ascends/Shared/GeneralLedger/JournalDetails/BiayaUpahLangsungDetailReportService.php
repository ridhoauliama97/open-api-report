...
class BiayaUpahLangsungDetailReportService
{
    private const TITLE = 'Laporan Biaya Upah Langsung';
    ...
    private function accountFilter(string $accountCode, string $company): bool
    {
        ...
        // 500.018.* is commented out in the original Crystal formula
        // if ($code7 === '500.018') { return true; }
