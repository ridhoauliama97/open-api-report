...
class PerhitunganBungaRuReportService
{
    private const TITLE = 'Laporan Piutang & Perhitungan Bunga RU';
    ...
    public function buildReportDataFromXml(string $xmlContents, string $sourceLabel = 'request xml payload', array $filters = []): array
    {
        ...
        $periodLabel = 'Piutang RU Bulan '.Carbon::parse($startDate)->locale('id')->isoFormat('MMMM YYYY');
        $bungaLabel = 'Perhitungan Bunga RU Bulan '.Carbon::parse($startDate)->locale('id')->isoFormat('MMMM YYYY');
