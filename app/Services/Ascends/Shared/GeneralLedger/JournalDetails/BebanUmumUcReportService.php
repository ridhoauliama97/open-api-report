...
class BebanUmumUcReportService
{
    private const TITLE = 'Laporan Beban Umum';

    private const EXCLUDED_ACCOUNT_CODES = [
        '721.000.251', '721.000.254', '721.000.257', '721.000.258',
        '721.000.259', '721.000.260', '721.000.261', '721.000.266',
        '721.000.267', '721.000.268', '721.000.269', '721.000.270',
    ];
    ...
    private function accountFilter(string $accountCode): bool
    {
        ...
        return ! in_array($accountCode, self::EXCLUDED_ACCOUNT_CODES, true);
    }
