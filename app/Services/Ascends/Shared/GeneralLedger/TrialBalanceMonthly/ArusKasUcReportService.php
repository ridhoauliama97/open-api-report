...
class ArusKasUcReportService
{
    ...
    private function tampilKas(string $ac1): bool
    {
        ...
        $plIstimewa = [
            '112.100.111', '112.100.112', '112.100.115', '112.100.116',
            '112.100.121', '112.100.122', '112.100.131', '112.100.132',
            '112.100.161', '112.100.163', '112.100.164', '112.100.166',
            '112.100.167', '112.100.168',
        ];
        ...
        $bebanYmd = [
            '211.300.011', '211.300.027', '211.300.029', '211.300.081',
            '211.300.171', '211.300.180', '211.300.211', '211.300.212',
        ];
        ...
        $kewajibanLancar = [
            '212.100.216', '212.100.217', '212.100.219', '212.100.220',
            '212.100.401', '212.100.402', '212.100.403', '212.100.404',
        ];
        ...
        $konstruksiProses = [
            '121.202.101', '121.202.102', '121.202.103', '121.202.104',
            '121.202.106', '121.202.107', '121.202.108', '121.202.109', '121.202.110',
        ];
        ...
        $hjp = [
            '221.100.201', '221.100.202', '221.100.203', '221.100.204',
            '221.100.206', '221.100.207', '221.100.208', '221.100.210',
            '221.100.211', '221.100.212', '221.100.301', '221.100.302',
            '221.100.304', '221.100.306', '221.100.307', '221.100.308',
            '221.100.303',
        ];
