...
class HasilCuciPerMesinReportService
{
    private const TITLE = 'Laporan Hasil Cuci Per Mesin';
        ...
        foreach ($groupedByLine as $machineKey => $machineGroup) {
            ...
            $machines[] = [
                ...
                'totals' => [
                    ...
                    'total_limbah' => $machineTotalLimbah,
                ],
    ...
    private function computeGrandTotals(array $machines): array
    {
        ...
        foreach ($machines as $machine) {
            ...
            $totalLimbah += $machine['totals']['total_limbah'];
        }
        ...
        foreach ($machines as &$machine) {
            $machine['percentages'] = [
                ...
                'limbah_pct' => $grandTotals['total_limbah'] > 0
                    ? round($machine['totals']['total_limbah'] / $grandTotals['total_limbah'] * 100)
                    : 0,
            ];
        }
