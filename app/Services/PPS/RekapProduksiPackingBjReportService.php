...
class RekapProduksiPackingBjReportService
{
    /**
    ...
    public function healthCheck(string $startDate, string $endDate): array
    {
        ...
        $expectedColumns = config('reports.pps_rekap_produksi_packing_bj.expected_columns', []);
    ...
    {
        $configPath = 'reports.pps_rekap_produksi_packing_bj';
        ...
        if ($driver !== 'sqlsrv' && $syntax !== 'query') {
            throw new RuntimeException(
                ...
                . 'Set PPS_REKAP_PRODUKSI_PACKING_BJ_REPORT_CALL_SYNTAX=query jika ingin memakai query manual pada driver lain.',
            );
        }
        ...
        if ($syntax === 'query') {
            $query = is_string($customQuery) && trim($customQuery) !== ''
                ? $customQuery
                : throw new RuntimeException(
                    'PPS_REKAP_PRODUKSI_PACKING_BJ_REPORT_QUERY belum diisi. '
                    . 'Isi query manual jika menggunakan PPS_REKAP_PRODUKSI_PACKING_BJ_REPORT_CALL_SYNTAX=query.',
                );
