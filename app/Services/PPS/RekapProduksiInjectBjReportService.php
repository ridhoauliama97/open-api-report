...
class RekapProduksiInjectBjReportService
{
    /**
    ...
    public function healthCheck(string $startDate, string $endDate): array
    {
        ...
        $expectedColumns = config('reports.pps_rekap_produksi_inject_bj.expected_columns', []);
    ...
    {
        $configPath = 'reports.pps_rekap_produksi_inject_bj';
