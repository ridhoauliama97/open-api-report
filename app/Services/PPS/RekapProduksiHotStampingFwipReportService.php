...
class RekapProduksiHotStampingFwipReportService
{
    /**
    ...
    public function healthCheck(string $startDate, string $endDate): array
    {
        ...
        $expectedColumns = config('reports.pps_rekap_produksi_hot_stamping_fwip.expected_columns', []);
    ...
    {
        $configPath = 'reports.pps_rekap_produksi_hot_stamping_fwip';
        ...
        if ($driver !== 'sqlsrv' && $syntax !== 'query') {
            throw new RuntimeException(
                ...
                . 'Set PPS_REKAP_PRODUKSI_HOT_STAMPING_FWIP_REPORT_CALL_SYNTAX=query jika ingin memakai query manual pada driver lain.',
            );
        }
        ...
        if ($syntax === 'query') {
            $query = is_string($customQuery) && trim($customQuery) !== ''
                ? $customQuery
                : throw new RuntimeException(
                    'PPS_REKAP_PRODUKSI_HOT_STAMPING_FWIP_REPORT_QUERY belum diisi. '
                    . 'Isi query manual jika menggunakan PPS_REKAP_PRODUKSI_HOT_STAMPING_FWIP_REPORT_CALL_SYNTAX=query.',
                );
