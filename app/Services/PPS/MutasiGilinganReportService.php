...
class MutasiGilinganReportService
{
    /**
    ...
    {
        $connectionName = config('reports.pps_mutasi_gilingan.database_connection');
        $procedureConfig = $procedureType === 'sub'
            ? 'reports.pps_mutasi_gilingan.sub_stored_procedure'
            : 'reports.pps_mutasi_gilingan.stored_procedure';
        $queryConfig = $procedureType === 'sub'
            ? 'reports.pps_mutasi_gilingan.sub_query'
            : 'reports.pps_mutasi_gilingan.query';
        ...
        if ($procedure === '' && !is_string($customQuery)) {
            throw new RuntimeException(
                $procedureType === 'sub'
                    ...
                    : 'Stored procedure laporan PPS mutasi gilingan belum dikonfigurasi.'
            );
        }
