...
class ProduksiFjPerNomorProduksiController extends Controller
{
    public function index(): View
    {
        return view('reports.proses-produksi.produksi-fj-per-nomor-produksi-form');
    }

    public function download(
        GenerateProduksiPerNomorProduksiReportRequest $request,
        ProduksiFjPerNomorProduksiReportService $reportService,
        ...
        $html = $pdfGenerator->renderHtml('reports.proses-produksi.produksi-fj-per-nomor-produksi-pdf', [
            'report' => $report,
    ...
    public function health(
        ...
        return response()->json([
            'message' => $result['is_healthy']
                ? 'Struktur output SPWps_LapProduksiFJ valid.'
                : 'Struktur output SPWps_LapProduksiFJ berubah.',
            'meta' => [
                'no_produksi' => $noProduksi,
                'NoProduksi' => $noProduksi,
            ],
