...
use App\Http\Requests\PPS\GenerateQcHarianBrokerReportRequest;
...
class QcHarianBrokerController extends Controller
{
    public function index(): View
    {
        return view('pps.qc.qc_harian_broker.form');
    }

    public function download(
        GenerateQcHarianBrokerReportRequest $request,
        QcHarianBrokerReportService $reportService,
        ...
        $pdf = $pdfGenerator->render('pps.qc.qc_harian_broker.pdf', [
            'rows' => $rows,
    ...
    public function health(
        ...
        return response()->json([
            'message' => $result['is_healthy']
                ? 'Struktur output SP_LaporanHasilQCHarianBroker valid.'
                : 'Struktur output SP_LaporanHasilQCHarianBroker berubah.',
            'meta' => [
                'report_date' => $reportDate,
                'EndDate' => $reportDate,
            ],
    ...
    private function resolveGeneratedBy(GenerateQcHarianBrokerReportRequest $request): object
    {
