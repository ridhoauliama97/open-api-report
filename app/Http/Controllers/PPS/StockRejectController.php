...
use App\Http\Requests\PPS\GenerateStockRejectReportRequest;
use App\Services\PdfGenerator;
use App\Services\PPS\StockRejectReportService;
...
class StockRejectController extends Controller
{
    ...
    {
        return view('pps.reject.stock_reject.form');
    }

    public function download(
        GenerateStockRejectReportRequest $request,
        StockRejectReportService $reportService,
        ...
        $pdf = $pdfGenerator->render('pps.reject.stock_reject.pdf', [
            'rows' => $rows,
            'startDate' => $startDate,
            'endDate' => $endDate,
    ...
    public function health(
        ...
        return response()->json([
            'message' => $result['is_healthy']
                ? 'Struktur output SP_LaporanStockLabelReject valid.'
                : 'Struktur output SP_LaporanStockLabelReject berubah.',
            'meta' => [
                'start_date' => $startDate,
                'end_date' => $endDate,
                'TglAwal' => $startDate,
    ...
    private function resolveGeneratedBy(GenerateStockRejectReportRequest $request): object
    {
