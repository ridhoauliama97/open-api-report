...
use App\Http\Requests\PPS\GenerateStockBrokerReportRequest;
use App\Services\PdfGenerator;
use App\Services\PPS\StockBrokerReportService;
...
class StockBrokerController extends Controller
{
    ...
    {
        return view('pps.broker.stock_broker.form');
    }

    public function download(
        GenerateStockBrokerReportRequest $request,
        StockBrokerReportService $reportService,
        ...
        $pdf = $pdfGenerator->render('pps.broker.stock_broker.pdf', [
            'rows' => $rows,
            'startDate' => $startDate,
            'endDate' => $endDate,
    ...
    public function health(
        ...
        return response()->json([
            'message' => $result['is_healthy']
                ? 'Struktur output SP_LaporanStockLabelBroker valid.'
                : 'Struktur output SP_LaporanStockLabelBroker berubah.',
            'meta' => [
                'start_date' => $startDate,
                'end_date' => $endDate,
                'TglAwal' => $startDate,
    ...
    private function resolveGeneratedBy(GenerateStockBrokerReportRequest $request): object
    {
