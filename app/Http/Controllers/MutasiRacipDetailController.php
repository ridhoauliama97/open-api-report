...
class MutasiRacipDetailController extends Controller
{
    ...
    public function download(
        ...
        $html = $pdfGenerator->renderHtml('reports.mutasi-racip-detail-pdf', [
    ...
    public function health(
        ...
        return response()->json([
            'message' => $result['is_healthy']
                ? 'Struktur output laporan mutasi racip detail valid.'
                : 'Struktur output laporan mutasi racip detail berubah.',
            'meta' => [
                'start_date' => $startDate,
                'end_date' => $endDate,
                'TglAwal' => $startDate,
