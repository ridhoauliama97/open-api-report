...
class RekapPenjualanPerProdukController extends Controller
{
    ...
    private function buildPdfResponse(
        ...
        $html = $pdfGenerator->renderHtml('reports.penjualan-kayu.rekap-penjualan-per-produk-pdf', [
            'startDate' => $startDate,
            'endDate' => $endDate,
        ...
        try {
            ...
            return response($pdf, 200, ['Content-Type' => 'application/pdf', 'Content-Disposition' => 'attachment; filename="Laporan Rekap Penjualan Per Produk"']);
