...
class ProduksiHuluHilirController extends Controller
{
    public function index(Request $request): View
    {
        return view('reports.management.produksi-hulu-hilir-form', [
    ...
    public function download(
        ...
        ProduksiHuluHilirReportService $reportService,
        ...
        $html = $pdfGenerator->renderHtml('reports.management.produksi-hulu-hilir-pdf', [
            'startDate' => $startDate,
            'endDate' => $endDate,
    ...
    public function health(
        ...
        return response()->json([
            'message' => $result['is_healthy']
                ? 'Struktur output SPWps_LapProduksiSemuaMesinV2 valid.'
                : 'Struktur output SPWps_LapProduksiSemuaMesinV2 berubah.',
            'meta' => [
                'start_date' => $startDate,
                'end_date' => $endDate,
                'TglAwal' => $startDate,
