...
class SaldoBarangJadiHidupPerJenisPerProdukController extends Controller
{
    ...
    public function download(
        ...
        $html = $pdfGenerator->renderHtml('reports.barang-jadi.saldo-barang-jadi-hidup-per-jenis-per-produk-pdf', [
        ...
        try {
            ...
            return response($pdf, 200, ['Content-Type' => 'application/pdf', 'Content-Disposition' => 'attachment; filename="Laporan Saldo Barang Jadi Hidup Per Jenis Per Produk"']);
