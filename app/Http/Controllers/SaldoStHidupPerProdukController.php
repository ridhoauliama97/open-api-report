...
class SaldoStHidupPerProdukController extends Controller
{
    ...
    public function download(
        ...
        $html = $pdfGenerator->renderHtml('reports.sawn-timber.saldo-st-hidup-per-produk-pdf', [
        ...
        try {
            ...
            return response($pdf, 200, ['Content-Type' => 'application/pdf', 'Content-Disposition' => 'attachment; filename="Laporan Saldo St Hidup Per Produk"']);
