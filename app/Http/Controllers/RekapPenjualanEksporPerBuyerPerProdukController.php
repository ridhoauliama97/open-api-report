...
class RekapPenjualanEksporPerBuyerPerProdukController extends Controller
{
    ...
    private function buildPdfResponse(
        ...
        $pdf = $pdfGenerator->render('reports.penjualan-kayu.rekap-penjualan-ekspor-per-buyer-per-produk-pdf', [
            'startDate' => $startDate,
            'endDate' => $endDate,
        ...
        $filename = sprintf(
            'Laporan-Rekap-Penjualan-Ekspor-Per-Buyer-dan-Per-Produk-%s-s_d-%s.pdf',
            $startDate,
            $endDate
        );
