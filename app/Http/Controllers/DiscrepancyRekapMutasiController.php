...
use App\Services\DiscrepancyRekapMutasiReportService;
...
class DiscrepancyRekapMutasiController extends Controller
{
    public function index(Request $request): View
    {
        return view('reports.management.discrepancy-rekap-mutasi-form', [
    ...
    public function download(
        ...
        DiscrepancyRekapMutasiReportService $reportService,
        ...
        $html = $pdfGenerator->renderHtml('reports.management.discrepancy-rekap-mutasi-pdf', [
            'startDate' => $startDate,
            'endDate' => $endDate,
        ...
        $filename = sprintf('Laporan-Discrepancy-Rekap-Mutasi-%s-sd-%s.pdf', $startDate, $endDate);
    ...
    public function health(
        ...
        return response()->json([
            'message' => $result['is_healthy']
                ? 'Struktur output SP_LapRekapMutasiV2 valid.'
                : 'Struktur output SP_LapRekapMutasiV2 berubah.',
            'meta' => [
                'start_date' => $startDate,
                'end_date' => $endDate,
                'TglAwal' => $startDate,
