...
use App\Http\Requests\ShowDashboardSandingRequest;
use App\Services\DashboardSandingReportService;
...
class DashboardSandingController extends Controller
{
    public function index(
        ShowDashboardSandingRequest $request,
        DashboardSandingReportService $reportService,
    ): View {
    ...
    public function preview(
        ...
        return response()->json([
            'message' => 'Data dashboard sanding berhasil diambil.',
            'meta' => [
    ...
    public function health(
        ...
        return response()->json([
            'message' => $result['is_healthy']
                ? 'Struktur output SPWps_LapDashboardSanding valid.'
                : 'Struktur output SPWps_LapDashboardSanding berubah.',
            'meta' => [
                'start_date' => $startDate,
                'end_date' => $endDate,
                'TglAwal' => $startDate,
    ...
    public function download(
        ...
        $html = $pdfGenerator->renderHtml('dashboard.sanding-pdf', [
            'startDate' => $startDate,
            'endDate' => $endDate,
            'reportData' => $reportData,
        ...
        try {
            ...
            return response($pdf, 200, ['Content-Type' => 'application/pdf', 'Content-Disposition' => 'attachment; filename="Dashboard Sanding"']);
    ...
    private function resolveDates(ShowDashboardSandingRequest $request): array
    {
        $defaultEndDate = now()->endOfMonth()->toDateString();
        $defaultStartDate = now()->startOfMonth()->toDateString();
