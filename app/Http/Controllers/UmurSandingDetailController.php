...
class UmurSandingDetailController extends Controller
{
    ...
    {
        return view('reports.sanding.umur-sanding-detail-form');
    }
    ...
    public function download(
        ...
        $html = $pdfGenerator->renderHtml('reports.sanding.umur-sanding-detail-pdf', $data);
    ...
    public function health(
        ...
        return response()->json([
            'message' => $result['is_healthy']
                ? 'Struktur output SP_LapUmurSanding valid.'
                : 'Struktur output SP_LapUmurSanding berubah.',
            'meta' => [
                'umur1' => $params['Umur1'],
                'umur2' => $params['Umur2'],
                'umur3' => $params['Umur3'],
