...
class RekapStockOnHandController extends Controller
{
    ...
    public function download(
        ...
        $html = $pdfGenerator->renderHtml('reports.management.rekap-stock-on-hand-pdf', [
            'startDate' => $startDate,
            'endDate' => $endDate,
        ...
        try {
            ...
            return response($pdf, 200, ['Content-Type' => 'application/pdf', 'Content-Disposition' => 'attachment; filename="Laporan Rekap Stock On Hand"']);
