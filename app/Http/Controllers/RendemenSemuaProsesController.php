...
class RendemenSemuaProsesController extends Controller
{
    ...
    private function buildPdfResponse(
        ...
        $html = $pdfGenerator->renderHtml('reports.rendemen-kayu.rendemen-semua-proses-pdf', [
        ...
        try {
            ...
            return response($pdf, 200, ['Content-Type' => 'application/pdf', 'Content-Disposition' => 'attachment; filename="Laporan Rendemen Semua Proses"']);
