...
class ProduksiLaminatingPerNomorProduksiController extends Controller
{
    ...
    {
        return view('reports.proses-produksi.produksi-laminating-per-nomor-produksi-form');
    }
    ...
    public function health(
        ...
        return response()->json([
            'message' => $result['is_healthy']
                ? 'Struktur output SPWps_LapProduksiLaminating valid.'
                : 'Struktur output SPWps_LapProduksiLaminating berubah.',
            'meta' => [
                'no_produksi' => $noProduksi,
                'NoProduksi' => $noProduksi,
            ],
