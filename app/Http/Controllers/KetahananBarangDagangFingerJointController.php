...
use App\Services\KetahananBarangDagangFingerJointReportService;
...
class KetahananBarangDagangFingerJointController extends Controller
{
    public function index(): View
    {
        return view('reports.finger-joint.ketahanan-barang-finger-joint-form');
    }

    public function previewPdf(
        GenerateDateRangeReportRequest $request,
        KetahananBarangDagangFingerJointReportService $reportService,
    ...
    private function renderPdf(
        ...
        $html = $pdfGenerator->renderHtml('reports.finger-joint.ketahanan-barang-finger-joint-pdf', [
    ...
    public function health(
        ...
        return response()->json([
            'message' => $result['is_healthy']
                ? 'Struktur output SP_LapKetahananBarangFingerJoint valid.'
                : 'Struktur output SP_LapKetahananBarangFingerJoint berubah.',
            'meta' => [
                'start_date' => $startDate,
                'end_date' => $endDate,
                'TglAwal' => $startDate,
