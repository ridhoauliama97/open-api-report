...
use App\Services\Ascends\Shared\CustomReport\CheckPriceGroupA\DaftarHargaEnamelAkunSpesialReportService;
...
use App\Services\Ascends\Shared\CustomReport\PenjualanVsBiayaPerjalananDinasReportService;
use App\Services\Ascends\Shared\CustomReport\SalesSummaryPerCustomerPerPeriodReportService;
...
use App\Services\Ascends\Shared\GeneralLedger\JournalDetails\BiayaProduksiReportService;
use App\Services\Ascends\Shared\GeneralLedger\JournalDetails\BiayaProduksiTidakLangsungReportService;
...
use App\Services\Ascends\Shared\GeneralLedger\JournalDetails\PendapatanDanBiayaLainBaruReportService;
...
use App\Services\Ascends\Shared\GeneralLedger\JournalDetails\PinjamanKaryawanReportService;
use App\Services\Ascends\Shared\GeneralLedger\JournalDetails\RekapBiayaLabaRugiReportService;
use App\Services\Ascends\Shared\GeneralLedger\JournalDetails\RingkasanAktivaReportService;
use App\Services\Ascends\Shared\GeneralLedger\TrialBalance\BiayaBayarDimukaReportService;
use App\Services\Ascends\Shared\GeneralLedger\TrialBalance\HutangLainnyaReportService;
use App\Services\Ascends\Shared\GeneralLedger\TrialBalance\HutangUCReportService;
use App\Services\Ascends\Shared\GeneralLedger\TrialBalance\NeracaPerBulanReportService;
use App\Services\Ascends\Shared\GeneralLedger\TrialBalance\RingkasanHutangBankReportService;
use App\Services\Ascends\Shared\GeneralLedger\TrialBalance\SaldoBankReportService;
...
class AscendXmlTestController extends Controller
{
    ...
    public function apiSharedCustomReportBiayaMobilTrukPdf(
        GenerateAscendsEmployeeListReportRequest $request,
        BiayaMobilTrukReportService $reportService,
        PdfGenerator $pdfGenerator,
    ) {
        try {
            $xmlPayload = $request->xmlPayload();
        ...
        $pdf = $pdfGenerator->render('ascends.shared.custom_report.biaya_mobil_truk.pdf', [
    ...
    public function apiSharedCustomReportCekProduksiGsuPdf(
        GenerateAscendsEmployeeListReportRequest $request,
        CekProduksiGsuReportService $reportService,
        PdfGenerator $pdfGenerator,
    ) {
        try {
            $xmlPayload = $request->xmlPayload();
        ...
        $pdf = $pdfGenerator->render('ascends.shared.custom_report.cek_produksi_gsu.pdf', [
            'company' => $companyShort,
            'reportData' => $reportData,
            'generatedAt' => now(),
    ...
    public function apiSharedCustomReportPengirimanPerKategoriHarianPdf(
        ...
        $pdf = $pdfGenerator->render('ascends.shared.custom_report.pengiriman_per_kategori_harian.pdf', [
            'company' => $companyShort,
            'reportData' => $reportData,
            'generatedAt' => now(),
            'pdf_format' => 'A4-L',
    ...
    public function apiSharedCustomReportPengirimanLemariTahunanPdf(
        GenerateAscendsEmployeeListReportRequest $request,
        PengirimanLemariTahunanReportService $reportService,
        PdfGenerator $pdfGenerator,
    ) {
        try {
            $xmlPayload = $request->xmlPayload();
    ...
    public function apiSharedCustomReportPengirimanLemariHarianPdf(
        GenerateAscendsEmployeeListReportRequest $request,
        PengirimanLemariHarianReportService $reportService,
        PdfGenerator $pdfGenerator,
    ) {
        try {
            $xmlPayload = $request->xmlPayload();
        ...
        $dayCount = count($reportData['day_numbers'] ?? []);
        $pdf = $pdfGenerator->render('ascends.shared.custom_report.pengiriman_lemari_harian.pdf', [
            'company' => $companyShort,
            'reportData' => $reportData,
            'generatedAt' => now(),
            'pdf_format' => 'A4-L',
    ...
    public function apiSharedCustomReportPenjualanPerKategoriBarangBulananPdf(
        GenerateAscendsEmployeeListReportRequest $request,
        PenjualanPerKategoriBarangBulananReportService $reportService,
        PdfGenerator $pdfGenerator,
    ) {
        try {
            $xmlPayload = $request->xmlPayload();
        ...
        $pdf = $pdfGenerator->render('ascends.shared.custom_report.penjualan_per_kategori_barang_bulanan.pdf', [
            'company' => $companyShort,
            'reportData' => $reportData,
            'generatedAt' => now(),
            'generatedByName' => $reportData['printed_by'] ?? 'sistem',
    ...
    public function apiSharedCustomReportPengirimanPerKategoriTahunanPdf(
        GenerateAscendsEmployeeListReportRequest $request,
        PengirimanPerKategoriTahunanReportService $reportService,
        PdfGenerator $pdfGenerator,
    ) {
        try {
            $xmlPayload = $request->xmlPayload();
        ...
        $pdf = $pdfGenerator->render('ascends.shared.custom_report.pengiriman_per_kategori_tahunan.pdf', [
            'company' => $companyShort,
            'reportData' => $reportData,
            'generatedAt' => now(),
            'pdf_format' => 'A4',
    ...
    public function apiSharedCustomReportDaftarHargaFurnitureAllPdf(
        GenerateAscendsEmployeeListReportRequest $request,
        DaftarHargaFurnitureAllReportService $reportService,
        PdfGenerator $pdfGenerator,
    ) {
        try {
            $xmlPayload = $request->xmlPayload();
    ...
    public function apiSharedCustomReportDaftarHargaEnamelAllPdf(
        GenerateAscendsEmployeeListReportRequest $request,
        DaftarHargaEnamelAllReportService $reportService,
        PdfGenerator $pdfGenerator,
    ) {
        try {
            $xmlPayload = $request->xmlPayload();
    ...
    public function apiSharedCustomReportDaftarHargaEnamelAkunSpesialPdf(
        GenerateAscendsEmployeeListReportRequest $request,
        DaftarHargaEnamelAkunSpesialReportService $reportService,
        PdfGenerator $pdfGenerator,
    ) {
        try {
            $xmlPayload = $request->xmlPayload();
    ...
    public function apiSharedCustomReportDaftarHargaFurnitureSalesProjectPdf(
        GenerateAscendsEmployeeListReportRequest $request,
        DaftarHargaFurnitureSalesProjectReportService $reportService,
        PdfGenerator $pdfGenerator,
    ) {
        try {
            $xmlPayload = $request->xmlPayload();
    ...
    public function apiSharedCustomReportSalesSummaryPerCustomerPerPeriodPdf(
        GenerateAscendsEmployeeListReportRequest $request,
        SalesSummaryPerCustomerPerPeriodReportService $reportService,
        PdfGenerator $pdfGenerator,
    ) {
        try {
            $xmlPayload = $request->xmlPayload();
        ...
        $pdf = $pdfGenerator->render('ascends.shared.custom_report.sales_summary_per_customer_per_period.pdf', [
            'company' => $companyShort,
            'reportData' => $reportData,
            'generatedAt' => now(),
            'generatedByName' => $reportData['printed_by'] ?? 'sistem',
    ...
    public function apiUcDataKaryawanStatusKerjaPdf(
        ...
        return response($pdf, 200, [
            'Content-Type' => 'application/pdf',
            'Content-Disposition' => 'attachment; filename="Laporan Data Karyawan (UC) - Status Kerja.pdf"',
        ]);
    }
    ...
    public function apiUcKaryawanMasukPerDepartemenPerTanggalMasukPdf(
        ...
        return response($pdf, 200, [
            'Content-Type' => 'application/pdf',
            'Content-Disposition' => 'attachment; filename="Laporan Karyawan Masuk Per Departemen Per Tanggal Masuk (UC).pdf"',
        ]);
    }
    ...
    public function apiSharedCustomReportPenjualanVsBiayaPerjalananDinasPdf(
        GenerateAscendsEmployeeListReportRequest $request,
        PenjualanVsBiayaPerjalananDinasReportService $reportService,
        PdfGenerator $pdfGenerator,
    ) {
        try {
            $xmlPayload = $request->xmlPayload();
        ...
        $pdf = $pdfGenerator->render('ascends.shared.custom_report.penjualan_vs_biaya_perjalanan_dinas.pdf', [
            'company' => $companyShort,
            'reportData' => $reportData,
            'generatedAt' => now(),
            'pdf_format' => 'A4',
    ...
    public function apiSharedCustomReportBudgetingRealisasiBiayaPromosiPenjualanPdf(
        GenerateAscendsEmployeeListReportRequest $request,
        BudgetingRealisasiBiayaPromosiPenjualanReportService $reportService,
        PdfGenerator $pdfGenerator,
    ) {
        try {
            $xmlPayload = $request->xmlPayload();
        ...
        $pdf = $pdfGenerator->render('ascends.shared.custom_report.budgeting_realisasi_biaya_promosi_penjualan.pdf', [
            'company' => $companyShort,
            'reportData' => $reportData,
            'generatedAt' => now(),
            'pdf_format' => 'A4',
    ...
    public function apiDaftarKaryawanBerdasarkanAbjadPdf(
        ...
        return response($pdf, 200, [
            'Content-Type' => 'application/pdf',
            'Content-Disposition' => 'attachment; filename="Laporan Daftar Karyawan (RU) - Berdasarkan Abjad.pdf"',
        ]);
    }
    ...
    public function apiUcDaftarKaryawanBerdasarkanAbjadPdf(
        ...
        return response($pdf, 200, [
            'Content-Type' => 'application/pdf',
            'Content-Disposition' => 'attachment; filename="Laporan Daftar Karyawan (UC) - Berdasarkan Abjad.pdf"',
        ]);
    }
    ...
    public function apiDaftarKaryawanPdf(
        ...
        return response($pdf, 200, [
            'Content-Type' => 'application/pdf',
            'Content-Disposition' => 'attachment; filename="Laporan Daftar Karyawan (RU).pdf"',
        ]);
    }
    ...
    public function apiUcDaftarKaryawanPdf(
        ...
        return response($pdf, 200, [
            'Content-Type' => 'application/pdf',
            'Content-Disposition' => 'attachment; filename="Laporan Daftar Karyawan (UC).pdf"',
        ]);
    }
    ...
    public function apiKaryawanAktifPerDepartemenPdf(
        ...
        return response($pdf, 200, [
            'Content-Type' => 'application/pdf',
            'Content-Disposition' => 'attachment; filename="Laporan Karyawan Aktif Per Departemen (RU).pdf"',
        ]);
    }
    ...
    public function apiKaryawanPerAgamaPdf(
        ...
        return response($pdf, 200, [
            'Content-Type' => 'application/pdf',
            'Content-Disposition' => 'attachment; filename="Laporan Karyawan Per Agama (RU).pdf"',
        ]);
    }
    ...
    public function apiKaryawanPerEtnisPdf(
        ...
        return response($pdf, 200, [
            'Content-Type' => 'application/pdf',
            'Content-Disposition' => 'attachment; filename="Laporan Karyawan Per Etnis (RU).pdf"',
        ]);
    }
    ...
    public function apiKaryawanPerLevelPdf(
        ...
        return response($pdf, 200, [
            'Content-Type' => 'application/pdf',
            'Content-Disposition' => 'attachment; filename="Laporan Karyawan Per Level (RU).pdf"',
        ]);
    }
    ...
    public function apiKaryawanPerUmurPdf(
        ...
        return response($pdf, 200, [
            'Content-Type' => 'application/pdf',
            'Content-Disposition' => 'attachment; filename="Laporan Karyawan Per Umur (RU).pdf"',
        ]);
    }
    ...
    public function apiKaryawanPerDepartemenPerJabatanPdf(
        ...
        return response($pdf, 200, [
            'Content-Type' => 'application/pdf',
            'Content-Disposition' => 'attachment; filename="Laporan Karyawan Per Departemen Per Jabatan (RU).pdf"',
        ]);
    }
    ...
    public function apiSharedGeneralLedgerLaporanLabaRugiGsuPdf(
        GenerateAscendsEmployeeListReportRequest $request,
        LaporanLabaRugiGsuReportService $reportService,
        PdfGenerator $pdfGenerator,
    ) {
        try {
            $xmlPayload = $request->xmlPayload();
        ...
        $pdf = $pdfGenerator->render('ascends.shared.general_ledger.journal_details.laporan_laba_rugi_gsu.pdf', [
            'company' => $company,
            'reportData' => $reportData,
            'generatedAt' => now(),
            'pdf_format' => 'A4',
    ...
    public function apiSharedGeneralLedgerRekapBiayaLabaRugiPdf(
        GenerateAscendsEmployeeListReportRequest $request,
        RekapBiayaLabaRugiReportService $reportService,
        PdfGenerator $pdfGenerator,
    ) {
        try {
            $xmlPayload = $request->xmlPayload();
        ...
        $pdf = $pdfGenerator->render('ascends.shared.general_ledger.journal_details.rekap_biaya_laba_rugi.pdf', [
            'company' => $company,
            'reportData' => $reportData,
            'generatedAt' => now(),
            'pdf_format' => 'A4',
    ...
    public function apiSharedGeneralLedgerPinjamanKaryawanPdf(
        GenerateAscendsEmployeeListReportRequest $request,
        PinjamanKaryawanReportService $reportService,
        PdfGenerator $pdfGenerator,
    ) {
        try {
            $xmlPayload = $request->xmlPayload();
        ...
        $pdf = $pdfGenerator->render('ascends.shared.general_ledger.journal_details.pinjaman_karyawan.pdf', [
            'company' => $company,
            'reportData' => $reportData,
            'generatedAt' => now(),
            'pdf_format' => 'A4',
    ...
    public function apiSharedGeneralLedgerPendapatanDanBiayaLainBaruPdf(
        GenerateAscendsEmployeeListReportRequest $request,
        PendapatanDanBiayaLainBaruReportService $reportService,
        PdfGenerator $pdfGenerator,
    ) {
        try {
            $xmlPayload = $request->xmlPayload();
        ...
        $pdf = $pdfGenerator->render('ascends.shared.general_ledger.journal_details.pendapatan_dan_biaya_lain_baru.pdf', [
            'company' => $company,
            'reportData' => $reportData,
            'generatedAt' => now(),
            'pdf_format' => 'A4',
    ...
    public function apiSharedGeneralLedgerBebanUmumBaruPdf(
        GenerateAscendsEmployeeListReportRequest $request,
        BebanUmumBaruReportService $reportService,
        PdfGenerator $pdfGenerator,
    ) {
        try {
            $xmlPayload = $request->xmlPayload();
        ...
        $pdf = $pdfGenerator->render('ascends.shared.general_ledger.journal_details.beban_umum_baru.pdf', [
            'company' => $company,
            'reportData' => $reportData,
            'generatedAt' => now(),
            'pdf_format' => 'A4',
    ...
    public function apiSharedGeneralLedgerBiayaUpahLangsungDetailPdf(
        ...
        $pdf = $pdfGenerator->render('ascends.shared.general_ledger.journal_details.biaya_upah_langsung_detail.pdf', [
            'company' => $company,
            'reportData' => $reportData,
            'generatedAt' => now(),
            'pdf_format' => 'A4',
    ...
    public function apiSharedGeneralLedgerBiayaProduksiTidakLangsungPdf(
        GenerateAscendsEmployeeListReportRequest $request,
        BiayaProduksiTidakLangsungReportService $reportService,
        PdfGenerator $pdfGenerator,
    ) {
        try {
            $xmlPayload = $request->xmlPayload();
        ...
        $pdf = $pdfGenerator->render('ascends.shared.general_ledger.journal_details.biaya_produksi_tidak_langsung.pdf', [
            'company' => $company,
            'reportData' => $reportData,
            'generatedAt' => now(),
            'pdf_format' => 'A4',
    ...
    public function apiSharedGeneralLedgerBiayaProduksiPdf(
        GenerateAscendsEmployeeListReportRequest $request,
        BiayaProduksiReportService $reportService,
        PdfGenerator $pdfGenerator,
    ) {
        try {
            $xmlPayload = $request->xmlPayload();
        ...
        $pdf = $pdfGenerator->render('ascends.shared.general_ledger.journal_details.biaya_produksi.pdf', [
            'company' => $company,
            'reportData' => $reportData,
            'generatedAt' => now(),
            'pdf_format' => 'A4',
    ...
    public function apiSharedGeneralLedgerRingkasanAktivaPdf(
        GenerateAscendsEmployeeListReportRequest $request,
        RingkasanAktivaReportService $reportService,
        PdfGenerator $pdfGenerator,
    ) {
        try {
            $xmlPayload = $request->xmlPayload();
    ...
    public function apiSharedGeneralLedgerPerhitunganBungaRuPdf(
        GenerateAscendsEmployeeListReportRequest $request,
        PerhitunganBungaRuReportService $reportService,
        PdfGenerator $pdfGenerator,
    ) {
        try {
            $xmlPayload = $request->xmlPayload();
            ...
            $rawStartDate = $allInput['Date.StartDate'] ?? $allInput['Date_StartDate'] ?? $allInput['StartDate'] ?? '';
            $rawEndDate = $allInput['Date.EndDate'] ?? $allInput['Date_EndDate'] ?? $allInput['EndDate'] ?? '';
            $saldoAwal = (float) ($allInput['SaldoAwal'] ?? $allInput['saldo_awal'] ?? 0);
        ...
        $pdf = $pdfGenerator->render('ascends.shared.general_ledger.journal_details.perhitungan_bunga_ru.pdf', [
            'company' => $company,
            'reportData' => $reportData,
            'generatedAt' => now(),
            'pdf_format' => 'A4',
    ...
    public function apiSharedGeneralLedgerPerhitunganBungaGsuPdf(
        GenerateAscendsEmployeeListReportRequest $request,
        PerhitunganBungaGsuReportService $reportService,
        PdfGenerator $pdfGenerator,
    ) {
        try {
            $xmlPayload = $request->xmlPayload();
        ...
        $pdf = $pdfGenerator->render('ascends.shared.general_ledger.journal_details.perhitungan_bunga_gsu.pdf', [
            'company' => $company,
            'reportData' => $reportData,
            'generatedAt' => now(),
            'pdf_format' => 'A4',
    ...
    public function apiSharedGeneralLedgerLabaKotorRuPdf(
        GenerateAscendsEmployeeListReportRequest $request,
    ...
    public function apiSharedGeneralLedgerLabaKotorPerKategoriPdf(
        GenerateAscendsEmployeeListReportRequest $request,
    ...
    public function apiSharedGeneralLedgerLabaKotorGsuPdf(
        GenerateAscendsEmployeeListReportRequest $request,
    ...
    public function apiSharedGeneralLedgerLabaRugiMultiPeriodeTahunanPdf(
        GenerateAscendsEmployeeListReportRequest $request,
        LabaRugiMultiPeriodeTahunanReportService $reportService,
        PdfGenerator $pdfGenerator,
    ) {
        try {
            $xmlPayload = $request->xmlPayload();
        ...
        $pdf = $pdfGenerator->render('ascends.shared.general_ledger.trial_balance_monthly.laba_rugi_multi_periode_tahunan.pdf', [
            'company' => $company,
            'reportData' => $reportData,
            'generatedAt' => now(),
            'pdf_format' => 'A4',
    ...
    public function apiSharedGeneralLedgerPendukungArusKasPdf(
        GenerateAscendsEmployeeListReportRequest $request,
        PendukungArusKasReportService $reportService,
        PdfGenerator $pdfGenerator,
    ) {
        try {
            $xmlPayload = $request->xmlPayload();
            ...
            $allInput = $request->all();
            $periodStart = $allInput['PeriodStart'] ?? $allInput['period_start'] ?? $allInput['start_date'] ?? $allInput['StartDate'] ?? '';
            $periodEnd = $allInput['PeriodEnd'] ?? $allInput['period_end'] ?? $allInput['end_date'] ?? $allInput['EndDate'] ?? '';
        ...
        $pdf = $pdfGenerator->render('ascends.shared.general_ledger.trial_balance_monthly.pendukung_arus_kas.pdf', [
            'company' => $company,
            'reportData' => $reportData,
            'generatedAt' => now(),
            'pdf_format' => 'A4',
    ...
    public function apiSharedGeneralLedgerSaldoBankPdf(
        GenerateAscendsEmployeeListReportRequest $request,
        SaldoBankReportService $reportService,
        PdfGenerator $pdfGenerator,
    ) {
        try {
            $xmlPayload = $request->xmlPayload();
            ...
            $company = $this->normalizeSharedHrmCompany($dbCompanyName);
            $dateEnd = trim((string) $request->input('DateEnd', ''));
        ...
        $pdf = $pdfGenerator->render('ascends.shared.general_ledger.trial_balance.saldo_bank.pdf', [
            'company' => $company,
            'reportData' => $reportData,
            'generatedAt' => now(),
            'pdf_format' => 'A4',
    ...
    public function apiSharedGeneralLedgerNeracaPerBulanPdf(
        GenerateAscendsEmployeeListReportRequest $request,
        NeracaPerBulanReportService $reportService,
        PdfGenerator $pdfGenerator,
    ) {
        try {
            $xmlPayload = $request->xmlPayload();
        ...
        $pdf = $pdfGenerator->render('ascends.shared.general_ledger.trial_balance.neraca_per_bulan.pdf', [
            'company' => $company,
            'reportData' => $reportData,
            'generatedAt' => now(),
            'pdf_format' => 'A4',
    ...
    public function apiSharedGeneralLedgerHutangUCPdf(
        GenerateAscendsEmployeeListReportRequest $request,
        HutangUCReportService $reportService,
        PdfGenerator $pdfGenerator,
    ) {
        try {
            $xmlPayload = $request->xmlPayload();
            ...
            $company = $this->normalizeSharedHrmCompany($dbCompanyName);
            $dateStart = trim((string) $request->input('DateStart', ''));
            $dateEnd = trim((string) $request->input('DateEnd', ''));
        ...
        $pdf = $pdfGenerator->render('ascends.shared.general_ledger.trial_balance.hutang_uc.pdf', [
            'company' => $company,
            'reportData' => $reportData,
            'generatedAt' => now(),
            'pdf_format' => 'A4',
    ...
    public function apiSharedGeneralLedgerHutangLainnyaPdf(
        GenerateAscendsEmployeeListReportRequest $request,
        HutangLainnyaReportService $reportService,
        PdfGenerator $pdfGenerator,
    ) {
        try {
            $xmlPayload = $request->xmlPayload();
        ...
        $pdf = $pdfGenerator->render('ascends.shared.general_ledger.trial_balance.hutang_lainnya.pdf', [
            'company' => $company,
            'reportData' => $reportData,
            'generatedAt' => now(),
            'pdf_format' => 'A4',
    ...
    public function apiSharedGeneralLedgerBiayaBayarDimukaPdf(
        GenerateAscendsEmployeeListReportRequest $request,
        BiayaBayarDimukaReportService $reportService,
        PdfGenerator $pdfGenerator,
    ) {
        try {
            $xmlPayload = $request->xmlPayload();
        ...
        $pdf = $pdfGenerator->render('ascends.shared.general_ledger.trial_balance.biaya_bayar_dimuka.pdf', [
            'company' => $company,
            'reportData' => $reportData,
            'generatedAt' => now(),
            'pdf_format' => 'A4',
    ...
    public function apiSharedGeneralLedgerRingkasanHutangBankPdf(
        GenerateAscendsEmployeeListReportRequest $request,
        RingkasanHutangBankReportService $reportService,
        PdfGenerator $pdfGenerator,
    ) {
        try {
            $xmlPayload = $request->xmlPayload();
        ...
        $pdf = $pdfGenerator->render('ascends.shared.general_ledger.trial_balance.ringkasan_hutang_bank.pdf', [
            'company' => $company,
            'reportData' => $reportData,
            'generatedAt' => now(),
            'pdf_format' => 'A4',
    ...
    public function apiSharedGeneralLedgerArusKasUcPdf(
        GenerateAscendsEmployeeListReportRequest $request,
        ArusKasUcReportService $reportService,
        PdfGenerator $pdfGenerator,
    ) {
        try {
            $xmlPayload = $request->xmlPayload();
        ...
        $pdf = $pdfGenerator->render('ascends.shared.general_ledger.trial_balance_monthly.arus_kas_uc.pdf', [
            'company' => $company,
            'reportData' => $reportData,
            'generatedAt' => now(),
            'pdf_format' => 'A4',
    ...
    public function apiSharedGeneralLedgerArusKasRuPdf(
        GenerateAscendsEmployeeListReportRequest $request,
        ArusKasRuReportService $reportService,
        PdfGenerator $pdfGenerator,
    ) {
        try {
            $xmlPayload = $request->xmlPayload();
        ...
        $pdf = $pdfGenerator->render('ascends.shared.general_ledger.trial_balance_monthly.arus_kas_ru.pdf', [
            'company' => $company,
            'reportData' => $reportData,
            'generatedAt' => now(),
            'pdf_format' => 'A4',
    ...
    public function apiSharedGeneralLedgerArusKasGsuPdf(
        GenerateAscendsEmployeeListReportRequest $request,
        ArusKasGsuReportService $reportService,
        PdfGenerator $pdfGenerator,
    ) {
        try {
            $xmlPayload = $request->xmlPayload();
        ...
        $pdf = $pdfGenerator->render('ascends.shared.general_ledger.trial_balance_monthly.arus_kas_gsu.pdf', [
            'company' => $company,
            'reportData' => $reportData,
            'generatedAt' => now(),
            'pdf_format' => 'A4',
