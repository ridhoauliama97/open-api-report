...
use App\Services\TimelineRekapPenjualanPerProdukReportService;
use Illuminate\Contracts\View\View;
use Illuminate\Http\JsonResponse;
use RuntimeException;

class TimelineRekapPenjualanPerProdukController extends Controller
{
    public function index(GenerateRekapPenjualanPerProdukReportRequest $request): View
    {
        return view('reports.penjualan-kayu.timeline-rekap-penjualan-per-produk-form', [
    ...
    public function preview(
        ...
        return response()->json([
            ...
            'meta' => [
                ...
                'month_keys' => $reportData['month_keys'] ?? [],
            ],
    ...
    public function health(
        ...
        return response()->json([
            'message' => $result['is_healthy']
                ? 'Struktur output SP_LapJualPerProdukTimeLine valid.'
                : 'Struktur output SP_LapJualPerProdukTimeLine berubah.',
            'meta' => [
                'TglAwal' => $startDate,
                'TglAkhir' => $endDate,
            ],
    ...
    private function buildPdfResponse(
        ...
        $html = $pdfGenerator->renderHtml('reports.penjualan-kayu.timeline-rekap-penjualan-per-produk-pdf', [
            'startDate' => $startDate,
            'endDate' => $endDate,
        ...
        try {
            ...
            return response($pdf, 200, ['Content-Type' => 'application/pdf', 'Content-Disposition' => 'attachment; filename="Laporan Timeline Rekap Penjualan Per Produk"']);
