...
class TimelineKayuBulatBulananController extends Controller
{
    ...
    private function buildPdfResponse(
        ...
        $html = $pdfGenerator->renderHtml('reports.kayu-bulat.timeline-kayu-bulat-bulanan-pdf', $viewData);
     ...
     * or returns an error.
     */
    private function gotenbergFailureResponse(GenerateTimelineKayuBulatBulananReportRequest $request, string $message): JsonResponse|RedirectResponse
    {
        if ($request->expectsJson()) {
