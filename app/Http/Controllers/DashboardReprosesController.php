...
class DashboardReprosesController extends Controller
{
    ...
    public function download(
        ...
        $html = $pdfGenerator->renderHtml('dashboard.reproses-pdf', [
            'startDate' => $startDate,
            'endDate' => $endDate,
            'reportData' => $reportData,
        ...
        try {
            ...
            return response($pdf, 200, ['Content-Type' => 'application/pdf', 'Content-Disposition' => 'attachment; filename="Dashboard Reproses"']);
