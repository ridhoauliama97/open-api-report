...
class ProduksiSandingPerNomorProduksiController extends Controller
{
    public function index(): View
    {
        return view('reports.proses-produksi.produksi-sanding-per-nomor-produksi-form');
    }

    public function download(
        GenerateProduksiPerNomorProduksiReportRequest $request,
        ProduksiSandingPerNomorProduksiReportService $reportService,
        ...
        $html = $pdfGenerator->renderHtml('reports.proses-produksi.produksi-sanding-per-nomor-produksi-pdf', [
            'report' => $report,
    ...
    public function health(
        ...
        return response()->json([
            'message' => $result['is_healthy']
                ? 'Struktur output SPWps_LapProduksiSanding valid.'
                : 'Struktur output SPWps_LapProduksiSanding berubah.',
            'meta' => [
                'no_produksi' => $noProduksi,
                'NoProduksi' => $noProduksi,
            ],
