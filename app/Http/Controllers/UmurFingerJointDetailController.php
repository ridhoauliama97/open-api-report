...
class UmurFingerJointDetailController extends Controller
{
    ...
    public function download(
        ...
        $html = $pdfGenerator->renderHtml('reports.finger-joint.umur-finger-joint-detail-pdf', $viewData);
     ...
     * or returns an error.
     */
    private function gotenbergFailureResponse(GenerateUmurFingerJointDetailReportRequest $request, string $message): JsonResponse|RedirectResponse
    {
        if ($request->expectsJson()) {
