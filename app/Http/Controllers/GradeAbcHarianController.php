...
class GradeAbcHarianController extends Controller
{
    use BuildsGotenbergPdfResponses;

    public function index(): View
    {
        return view('reports.s4s.grade-abc-harian-form');
    }

    public function previewPdf(
        GenerateDateRangeReportRequest $request,
        GradeAbcHarianReportService $reportService,
    ...
    private function renderPdf(
        ...
        $html = $pdfGenerator->renderHtml('reports.s4s.grade-abc-harian-pdf', [
        ...
        $filename = 'Laporan-Grade-ABC-Harian.pdf';
    ...
    public function preview(
        ...
        return response()->json([
            ...
            'meta' => [
                ...
                'columns' => ['Tanggal', 'GRADE A', 'GRADE AB/AC', 'GRADE CC', 'GRADE CUT', 'Total'],
            ],
            'data' => $reportData,
        ]);
    }
    ...
    public function health(
        ...
        return response()->json([
            'message' => $result['is_healthy']
                ? 'Struktur output SPWps_LapGradeABCHarian valid.'
                : 'Struktur output SPWps_LapGradeABCHarian berubah.',
            'meta' => [
                'start_date' => $startDate,
                'end_date' => $endDate,
                'TglAwal' => $startDate,
