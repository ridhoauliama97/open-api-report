...
class SupplierIntelController extends Controller
{
    ...
    private function buildPdfResponse(
        ...
        $html = $pdfGenerator->renderHtml('reports.kayu-bulat-rambung.supplier-intel-pdf', [
            'rows' => $rows,
            'startDate' => $startDate,
            'endDate' => $endDate,
        ...
        return $this->buildGotenbergPdfResponse($request, $html, 'Laporan Supplier Intel', $paperMetrics, $footerHtml, 'attachment');
    }
