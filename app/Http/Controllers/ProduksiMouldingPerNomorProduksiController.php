...
class ProduksiMouldingPerNomorProduksiController extends Controller
{
    public function index(): View
    {
        return view('reports.proses-produksi.produksi-moulding-per-nomor-produksi-form');
    }

    public function download(
        GenerateProduksiPerNomorProduksiReportRequest $request,
        ProduksiMouldingPerNomorProduksiReportService $reportService,
        ...
        $html = $pdfGenerator->renderHtml('reports.proses-produksi.produksi-moulding-per-nomor-produksi-pdf', [
            'report' => $report,
        ...
        $filename = sprintf('Laporan-Produksi-Moulding-Per-Nomor-Produksi-%s.pdf', str_replace(['\\', '/', ' '], '-', $noProduksi));
    ...
    public function health(
        ...
        return response()->json([
            'message' => $result['is_healthy']
                ? 'Struktur output SPWps_LapProduksiMoulding valid.'
                : 'Struktur output SPWps_LapProduksiMoulding berubah.',
            'meta' => [
                'no_produksi' => $noProduksi,
                'NoProduksi' => $noProduksi,
            ],
