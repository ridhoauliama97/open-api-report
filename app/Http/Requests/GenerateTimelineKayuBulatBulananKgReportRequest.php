...
class GenerateTimelineKayuBulatBulananKgReportRequest extends BaseReportRequest
{
    ...
    {
        $parameterCount = (int) config('reports.timeline_kayu_bulat_bulanan_kg.parameter_count', 2);
