...
class GenerateRekapPenerimaanSTDariSawmillNonRambungReportRequest extends BaseReportRequest
{
    ...
    {
        $parameterCount = (int) config('reports.rekap_penerimaan_st_dari_sawmill_non_rambung.parameter_count', 2);
