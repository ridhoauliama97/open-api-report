...
class GenerateTimelineKayuBulatBulananReportRequest extends BaseReportRequest
{
    ...
    {
        $parameterCount = (int) config('reports.timeline_kayu_bulat_bulanan.parameter_count', 2);
