...
class GenerateAscendsEmployeeListReportRequest extends BaseReportRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'Pilih Kategori' => ['nullable', 'string', 'max:50'],
