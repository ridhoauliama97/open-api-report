...
class GenerateRekapPenerimaanSTDariSawmillKgReportRequest extends BaseReportRequest
{
    ...
    {
        $parameterCount = (int) config('reports.rekap_penerimaan_st_dari_sawmill_kg.parameter_count', 2);
