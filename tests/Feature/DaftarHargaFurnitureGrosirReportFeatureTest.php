...
class DaftarHargaFurnitureGrosirReportFeatureTest extends TestCase
{
    public function test_daftar_harga_furniture_grosir_pdf_download_works_without_db_company_name(): void
    {
