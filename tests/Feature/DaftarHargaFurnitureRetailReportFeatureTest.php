...
class DaftarHargaFurnitureRetailReportFeatureTest extends TestCase
{
    public function test_daftar_harga_furniture_retail_pdf_download_works_without_db_company_name(): void
    {
