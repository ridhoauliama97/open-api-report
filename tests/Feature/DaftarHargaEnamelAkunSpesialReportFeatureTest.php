...
class DaftarHargaEnamelAkunSpesialReportFeatureTest extends TestCase
{
    public function test_daftar_harga_enamel_akun_spesial_pdf_download_works_without_db_company_name(): void
    {
    ...
    private function sampleXml(): string
    {
        $rows = [
            ...
            $this->table('ENAMEL', 'SEKAR PIRING SOUP', '12', '1', '04. Harga Akun Special', '50000', '45500'),
            $this->table('ENAMEL', 'BASKOM DALAM 24 CM', '6', '1', '01. Harga Retail', '50000', '48500'),
            $this->table('ENAMEL', 'BASKOM DALAM 24 CM', '6', '1', '04. Harga Akun Special', '50000', '45500'),
        ];
