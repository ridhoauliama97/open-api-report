...
class OpenApiFeatureTest extends TestCase
{
    ...
    public function test_openapi_json_endpoint_is_available(): void
    {
        $this->get('/api/openapi.json')
            ...
            ->assertJsonPath('paths./api/reports/mutasi-laminating.post.summary', 'Preview data laporan mutasi laminating')
            ->assertJsonPath('paths./api/reports/mutasi-laminating/pdf.post.summary', 'Generate laporan mutasi laminating PDF')
            ->assertJsonPath('paths./api/reports/mutasi-laminating/health.post.summary', 'Cek kesehatan struktur output SP mutasi laminating')
            ->assertJsonPath('paths./api/reports/mutasi-sanding.post.summary', 'Preview data laporan mutasi sanding')
            ->assertJsonPath('paths./api/reports/mutasi-sanding/pdf.post.summary', 'Generate laporan mutasi sanding PDF')
            ->assertJsonPath('paths./api/reports/mutasi-sanding/health.post.summary', 'Cek kesehatan struktur output SP mutasi sanding')
