...
class UmurSawnTimberDetailTonReportServiceTest extends TestCase
{
    public function test_fetch_groups_same_jenis_dimension_rows_and_sums_age_periods(): void
    {
        config()->set('reports.umur_sawn_timber_detail_ton.database_connection', null);
        config()->set('reports.umur_sawn_timber_detail_ton.call_syntax', 'query');
        config()->set('reports.umur_sawn_timber_detail_ton.parameter_count', 0);
        config()->set('reports.umur_sawn_timber_detail_ton.query', implode(' UNION ALL ', [
        ...
        $rows = (new UmurSawnTimberDetailTonReportService)->fetch([
            'Umur1' => 15,
            'Umur2' => 30,
            'Umur3' => 60,
            'Umur4' => 90,
