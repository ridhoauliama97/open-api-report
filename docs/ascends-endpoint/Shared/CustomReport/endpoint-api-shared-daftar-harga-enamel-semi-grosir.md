# Dokumentasi Endpoint API Ascend Shared Daftar Harga Enamel Semi Grosir

Dokumen ini berisi endpoint internal untuk test/render laporan **Daftar Harga Enamel Semi Grosir** Ascend yang memakai Blade shared.
...
### Daftar Harga Enamel Semi Grosir

`POST /api/internal/ascends/shared/custom-report/check-price-group-a/daftar-harga-enamel-semi-grosir/pdf`

**Route name:** `api.internal.ascends.shared.custom-report.check-price-group-a.daftar-harga-enamel-semi-grosir.pdf`

**Controller:** `AscendXmlTestController::apiSharedCustomReportDaftarHargaEnamelSemiGrosirPdf`

**Deskripsi:** Laporan daftar harga enamel level semi grosir (harga konsumen + harga semi grosir diskon 5%).
...
| Kolom | Data Source |
|---|---|
| Isi/Dus | `PerDus` (level 02. Harga Semi Grosir, dibulatkan tanpa desimal) |
...
| No | Nama Barang | Isi/Dus | Harga Konsumen | Semi Grosir (5 %) |
|---|---|---|---|---|
