# Dokumentasi Endpoint API Ascend Shared Daftar Harga Furniture Akun Spesial

Dokumen ini berisi endpoint internal untuk test/render laporan **Daftar Harga Furniture Akun Spesial** Ascend yang memakai Blade shared.
...
### Daftar Harga Furniture Akun Spesial

`POST /api/internal/ascends/shared/custom-report/check-price-group-a/daftar-harga-furniture-akun-spesial/pdf`

**Route name:** `api.internal.ascends.shared.custom-report.check-price-group-a.daftar-harga-furniture-akun-spesial.pdf`

**Controller:** `AscendXmlTestController::apiSharedCustomReportDaftarHargaFurnitureAkunSpesialPdf`
