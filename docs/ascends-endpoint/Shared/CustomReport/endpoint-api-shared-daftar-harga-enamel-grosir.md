# Dokumentasi Endpoint API Ascend Shared Daftar Harga Enamel Grosir

Dokumen ini berisi endpoint internal untuk test/render laporan **Daftar Harga Enamel Grosir** Ascend yang memakai Blade shared.
...
### Daftar Harga Enamel Grosir

`POST /api/internal/ascends/shared/custom-report/check-price-group-a/daftar-harga-enamel-grosir/pdf`

**Route name:** `api.internal.ascends.shared.custom-report.check-price-group-a.daftar-harga-enamel-grosir.pdf`

**Controller:** `AscendXmlTestController::apiSharedCustomReportDaftarHargaEnamelGrosirPdf`

**Deskripsi:** Laporan daftar harga enamel level grosir (harga konsumen + harga grosir diskon 7%).
...
| Kolom | Data Source |
|---|---|
| Isi/Dus | `PerDus` (level 03. Harga Grosir, dibulatkan tanpa desimal) |
...
| No | Nama Barang | Isi/Dus | Harga Konsumen | Grosir (7 %) |
|---|---|---|---|---|
...
4. Dengan berlakunya Price List ini maka Price List sebelumnya tidak berlaku lagi
