...
<head>
    ...
    <title>Generate Laporan Output Produksi S4S Per Grade</title>
    ...
    <main class="container py-5">
        <div class="card border-0 shadow-sm">
            <div class="card-body p-4 p-md-5">
                <h1 class="h3 mb-3">Generate Laporan Output Produksi S4S Per Grade</h1>
                <p class="text-secondary mb-4">
                    Laporan ini mengambil data dari stored procedure <code>SPWps_LapProduksiOutputS4SPerGrade</code>.
                </p>
                ...
                <form method="POST" action="{{ route('reports.s4s.output-produksi-s4s-per-grade.download') }}"
                    class="row g-3">
                    @csrf
                    <div class="col-md-6">
                    ...
                    <div class="col-12">
                        <div class="d-flex gap-2 flex-wrap">
                            ...
                            <button type="submit" class="btn btn-outline-primary"
                                formaction="{{ route('reports.s4s.output-produksi-s4s-per-grade.preview-pdf') }}"
                ...
                <script>
                    document.getElementById('previewJsonBtn')?.addEventListener('click', async () => {
                        ...
                        const response = await fetch(
                            '{{ route('reports.s4s.output-produksi-s4s-per-grade.preview') }}', {
                                method: 'POST',
                                headers: {
