...
<head>
    ...
    <title>Generate Laporan Ketahanan Barang Dagang S4S</title>
    ...
    <main class="container py-5">
        <div class="card border-0 shadow-sm">
            <div class="card-body p-4 p-md-5">
                <h1 class="h3 mb-3">Generate Laporan Ketahanan Barang Dagang S4S</h1>
                <p class="text-secondary mb-4">
                    Laporan ini mengambil data dari stored procedure <code>SP_LapKetahananBarangS4S</code>.
                </p>
                ...
                <form method="POST" action="{{ route('reports.s4s.ketahanan-barang-s4s.download') }}" class="row g-3">
                    @csrf
                    <div class="col-md-6">
                    ...
                    <div class="col-12">
                        <div class="d-flex gap-2 flex-wrap">
                            ...
                            <button type="submit" class="btn btn-outline-primary"
                                formaction="{{ route('reports.s4s.ketahanan-barang-s4s.preview-pdf') }}"
                ...
                <script>
                    document.getElementById('previewJsonBtn')?.addEventListener('click', async () => {
                        ...
                        const response = await fetch(
                            '{{ route('reports.s4s.ketahanan-barang-s4s.preview') }}', {
                                method: 'POST',
                                headers: {
