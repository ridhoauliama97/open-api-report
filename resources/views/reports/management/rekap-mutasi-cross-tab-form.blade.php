...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Noto+Serif:ital,wght@0,100..900;1,100..900&display=swap"
        rel="stylesheet">
    <title>Generate Laporan Rekap Mutasi (Cross Tab)</title>
    ...
    <main class="container py-5">
        <div class="card border-0 shadow-sm">
            <div class="card-body p-4 p-md-5">
                <h1 class="h3 mb-3">Generate Laporan Rekap Mutasi (Cross Tab) (PDF)</h1>
                <p class="text-secondary mb-4">
                    Laporan ini mengambil data dari <code>SP_LapRekapMutasi</code> dan menampilkannya dalam format
                    cross tab harian seperti layout desktop.
                </p>
                ...
                <form method="POST" action="{{ route('reports.management.rekap-mutasi-cross-tab.download') }}"
                    class="row g-3">
                    @csrf
                    <div class="col-md-4">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            previewButton.addEventListener('click', async function() {
                ...
                try {
                    const response = await fetch('{{ route('reports.management.rekap-mutasi-cross-tab.preview') }}', {
                        method: 'POST',
                        headers: {
