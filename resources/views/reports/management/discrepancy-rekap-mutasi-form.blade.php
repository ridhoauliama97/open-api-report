...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Noto+Serif:ital,wght@0,100..900;1,100..900&display=swap"
        rel="stylesheet">
    <title>Generate Laporan Discrepancy Rekap Mutasi</title>
    ...
    <main class="container py-5">
        <div class="card border-0 shadow-sm">
            <div class="card-body p-4 p-md-5">
                <h1 class="h3 mb-3">Generate Laporan Discrepancy Rekap Mutasi (PDF)</h1>
                <p class="text-secondary mb-4">
                    Laporan ini mengikuti pola aplikasi desktop dan mengambil data dari
                    <code>SP_LapRekapMutasiV2</code> dengan kombinasi mode <code>1</code>, <code>2</code>, dan
                    <code>3</code>.
                </p>
                ...
                <form method="POST" action="{{ route('reports.management.discrepancy-rekap-mutasi.download') }}"
                    class="row g-3">
                    @csrf
                    <div class="col-md-4">
            ...
            previewButton.addEventListener('click', async function() {
                ...
                try {
                    const response = await fetch(
                        '{{ route('reports.management.discrepancy-rekap-mutasi.preview') }}', {
                            method: 'POST',
                            headers: {
