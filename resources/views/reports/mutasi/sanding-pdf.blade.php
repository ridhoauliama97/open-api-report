    ...
    <table class="report-table">
        <thead>
            <tr class="headers-row">
                ...
                <th rowspan="2" style="width: 207px;">Jenis</th>
                <th rowspan="2" style="width: 59px;">Awal</th>
                <th colspan="3">Masuk</th>
                <th rowspan="2" style="width: 63px;">Total<br>Masuk</th>
                <th colspan="8">Keluar</th>
                <th rowspan="2" style="width: 63px;">Total<br>Keluar</th>
                <th rowspan="2" style="width: 59px;">Akhir</th>
            </tr>
            <tr class="headers-row">
                <th style="width: 61px;">Adj Outp<br>SAND</th>
                <th style="width: 61px;">BS Outp<br>SAND</th>
                <th style="width: 61px;">SAND Prod<br>Outp</th>
                <th style="width: 61px;">Adj Inpt<br>SAND</th>
                <th style="width: 61px;">BS Inpt<br>SAND</th>
                <th style="width: 61px;">SAND<br>Jual</th>
                <th style="width: 61px;">CCA Input<br>SAND</th>
                <th style="width: 61px;">LMT Inpt<br>SAND</th>
                <th style="width: 61px;">MLD Inpt<br>SAND</th>
                <th style="width: 61px;">PACK Inpt<br>SAND</th>
                <th style="width: 61px;">SAND Inpt<br>SAND</th>
            </tr>
        </thead>
        <tbody>
