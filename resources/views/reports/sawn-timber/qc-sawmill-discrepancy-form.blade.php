...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Noto+Serif:ital,wght@0,100..900;1,100..900&display=swap"
        rel="stylesheet">
    <title>Generate Laporan QC Sawmill - Discrepancy</title>
    ...
    <main class="container py-5">
        <div class="card border-0 shadow-sm">
            <div class="card-body p-4 p-md-5">
                <h1 class="h3 mb-3">Generate Laporan QC Sawmill - Discrepancy (PDF)</h1>
                <p class="text-secondary mb-4">
                    Laporan ini mengambil data langsung dari stored procedure <code>SP_LapQCSawmillDescr</code>
                ...
                <form method="POST" action="{{ route('reports.sawn-timber.qc-sawmill-discrepancy.download') }}" class="row g-3">
                    @csrf
                    <div class="col-md-4">
                    ...
                    <div class="col-12">
                        <div class="d-flex gap-2 flex-wrap">
                            ...
                            <button type="submit" class="btn btn-outline-primary"
                                formaction="{{ route('reports.sawn-timber.qc-sawmill-discrepancy.preview-pdf') }}"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            previewButton.addEventListener('click', async function() {
                ...
                try {
                    const response = await fetch('{{ route('reports.sawn-timber.qc-sawmill-discrepancy.preview') }}', {
                        method: 'POST',
                        headers: {
