...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Noto+Serif:ital,wght@0,100..900;1,100..900&display=swap"
        rel="stylesheet">
    <title>Generate Laporan Umur Sawn Timber Detail (Ton)</title>
...
<body class="bg-light">
    ...
    <main class="container py-5">
        <div class="card border-0 shadow-sm">
            <div class="card-body p-4 p-md-5">
                <h1 class="h3 mb-3">Generate Laporan Umur Sawn Timber Detail (Ton) (PDF)</h1>
                <p class="text-secondary mb-4">
                    Laporan ini mengambil data langsung dari <code>SPWps_LapUmurST</code>
                    dengan parameter <code>@Umur1</code>, <code>@Umur2</code>, <code>@Umur3</code>, <code>@Umur4</code>.
                </p>
                @if ($errors->any())
                ...
                <form method="POST" action="{{ route('reports.sawn-timber.umur-sawn-timber-detail-ton.download') }}" class="row g-3">
                    @csrf
                    <div class="col-md-3">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (!previewButton || !previewWrapper || !previewOutput || !umur1Input || !umur2Input || !umur3Input || !umur4Input) {
                return;
            }
            ...
            previewButton.addEventListener('click', async function() {
                ...
                try {
                    const response = await fetch(
                        '{{ route('reports.sawn-timber.umur-sawn-timber-detail-ton.preview') }}', {
                            method: 'POST',
                            headers: {
                            ...
                            body: JSON.stringify({
                                Umur1: umur1Input.value,
                                Umur2: umur2Input.value,
                                Umur3: umur3Input.value,
                                Umur4: umur4Input.value,
                            }),
                        });
