    ...
    @foreach ($mainGroups as $group)
        ...
        @foreach ($dateGroups as $dg)
            @php
                ...
                $splitIndex = (int) ceil(count($indexedRows) / 2);
                $leftRows = array_slice($indexedRows, 0, $splitIndex);
                $rightRows = array_slice($indexedRows, $splitIndex);
                            ...
                            <table class="report-table split-table">
                                <thead>
                                    <tr class="headers-row">
                                        ...
                                        <th style="width: 20%;">Ton Racip</th>
                                    </tr>
                                </thead>
                                <tbody>
        ...
        <table class="report-table" style="border: 0;border-collapse: collapse; border-spacing: 0;">
            <tbody>
                <tr class="totals-row">
                    ...
                    <td style="width: 25%; border: 0;border-collapse: collapse; border-spacing: 0;">
                        RB STD : {{ $formatNumber($mejaTotals['RB STD']) }}</td>
                    <td style="width: 25%; border: 0;border-collapse: collapse; border-spacing: 0;">
