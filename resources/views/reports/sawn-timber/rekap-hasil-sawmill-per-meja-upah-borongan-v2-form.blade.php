...
<head>
    ...
    <title>Generate Laporan Rekap Hasil Sawmill Per-Meja (Semua Meja)</title>
    ...
    <main class="container py-5">
        <div class="card border-0 shadow-sm">
            <div class="card-body p-4 p-md-5">
                <h1 class="h3 mb-3">Generate Laporan Rekap Hasil Sawmill Per-Meja (Semua Meja)</h1>
                <p class="text-secondary mb-4">
                    Laporan ini mengambil data dari stored procedure
                    <code>SPWps_LapRekapHasilSawmillPerMejaUpahBoronganV2</code> dan
                    <code>SPWps_LapRekapHasilSawmillPerMejaUpahBoronganV2_Sub</code>.
                </p>
                ...
                <form method="POST"
                    action="{{ route('reports.sawn-timber.rekap-hasil-sawmill-per-meja-upah-borongan-v2.download') }}"
                    class="row g-3">
                    @csrf
                    <div class="col-md-4">
                    ...
                    <div class="col-12">
                        <div class="d-flex gap-2 flex-wrap">
                            ...
                            <button type="submit" class="btn btn-outline-primary"
                                formaction="{{ route('reports.sawn-timber.rekap-hasil-sawmill-per-meja-upah-borongan-v2.preview-pdf') }}"
            ...
            previewButton.addEventListener('click', async function() {
                ...
                try {
                    const response = await fetch(
                        '{{ route('reports.sawn-timber.rekap-hasil-sawmill-per-meja-upah-borongan-v2.preview') }}', {
                            method: 'POST',
                            headers: {
