...
<head>
    ...
    <title>Generate Laporan Ketahanan Barang Dagang ST</title>
    ...
    <main class="container py-5">
        <div class="card border-0 shadow-sm">
            <div class="card-body p-4 p-md-5">
                <h1 class="h3 mb-3">Generate Laporan Ketahanan Barang Dagang ST</h1>
                <p class="text-secondary mb-4">
                    Laporan ini mengambil data dari stored procedure <code>SP_LapKetahananBarangST</code>.
                </p>
                ...
                <form method="POST" action="{{ route('reports.sawn-timber.ketahanan-barang-st.download') }}"
                    class="row g-3">
                    @csrf
                    <div class="col-md-6">
                    ...
                    <div class="col-12">
                        <div class="d-flex gap-2 flex-wrap">
                            ...
                            <button type="submit" class="btn btn-outline-primary"
                                formaction="{{ route('reports.sawn-timber.ketahanan-barang-st.preview-pdf') }}"
                ...
                <script>
                    document.getElementById('previewJsonBtn')?.addEventListener('click', async () => {
                        ...
                        const response = await fetch(
                            '{{ route('reports.sawn-timber.ketahanan-barang-st.preview') }}', {
                                method: 'POST',
                                headers: {
