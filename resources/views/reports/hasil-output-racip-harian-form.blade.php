...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Noto+Serif:ital,wght@0,100..900;1,100..900&display=swap"
        rel="stylesheet">
    <title>Generate Laporan Hasil Output Racip Harian</title>
    ...
    <main class="container py-5">
        <div class="card border-0 shadow-sm">
            <div class="card-body p-4 p-md-5">
                <h1 class="h3 mb-3">Generate Laporan Hasil Output Racip Harian (PDF)</h1>
                <p class="text-secondary mb-4">
                    Isi tanggal akhir, lalu sistem akan mengambil data dari
                    <code>SP_LapHasilOutputRacipHarian</code>.
                </p>
                @if ($errors->any())
                ...
                <form method="POST" action="{{ route('reports.hasil-output-racip-harian.download') }}" class="row g-3">
                    @csrf
                    <div class="col-md-6">
            ...
            previewButton.addEventListener('click', async function() {
                ...
                try {
                    const response = await fetch(
                        '{{ route('reports.hasil-output-racip-harian.preview') }}', {
                            method: 'POST',
                            headers: {
