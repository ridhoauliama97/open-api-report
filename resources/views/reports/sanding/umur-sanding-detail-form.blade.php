...
<head>
    ...
    <title>Laporan Umur Sanding Detail</title>
                ...
                <div class="card border-0 shadow-sm">
                    <div class="card-body p-4 p-md-5">
                        <div class="d-flex justify-content-between align-items-start flex-wrap gap-3 mb-4">
                            <div>
                                <h1 class="h3 mb-1">Laporan Umur Sanding Detail</h1>
                                <p class="text-secondary mb-0">
                                    Generate laporan PDF, preview PDF, atau preview JSON dari SP_LapUmurSanding.
                                </p>
                            </div>
                        ...
                        <form method="POST" action="{{ route('reports.sanding.umur-sanding-detail.download') }}"
                            class="row g-3">
                            @csrf
                            ...
                            <div class="col-12">
                                <div class="d-flex flex-wrap gap-2 pt-2">
                                    ...
                                    <button type="submit" class="btn btn-outline-primary"
                                        formaction="{{ route('reports.sanding.umur-sanding-detail.preview-pdf') }}"
                                        formtarget="_blank">
                                        Preview PDF
                                    </button>
            ...
            previewButton.addEventListener('click', async () => {
                ...
                try {
                    ...
                    const response = await fetch(
                        '{{ route('reports.sanding.umur-sanding-detail.preview') }}', {
                            method: 'POST',
                            headers: {
