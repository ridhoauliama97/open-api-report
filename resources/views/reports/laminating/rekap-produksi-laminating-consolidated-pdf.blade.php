        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th rowspan="2" style="width: 38.4px;">Output<br>Laminating</th>
                ...
                <tr>
                    ...
                    <th style="width: 38.4px;">CCAkhir</th>
            ...
            <tbody>
                ...
                @if ($loop->last && $grandTotals !== [])
                    <tr class="grand-total-row">
                        ...
                        <td class="number">{{ $fmtBlank($grandTotals['Sanding'] ?? null) }}</td>
                        <td class="number">{{ $fmtBlank($grandTotals['TotalInput'] ?? null) }}</td>
                        <td class="number">{{ $fmtBlank($grandTotals['OutputLaminating'] ?? null) }}</td>
