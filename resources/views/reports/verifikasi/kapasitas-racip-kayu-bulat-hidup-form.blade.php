...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Noto+Serif:ital,wght@0,100..900;1,100..900&display=swap"
        rel="stylesheet">
    <title>Generate Laporan Kapasitas Racip Kayu Bulat Hidup (Ton)</title>
    ...
    <main class="container py-5">
        <div class="card border-0 shadow-sm">
            <div class="card-body p-4 p-md-5">
                <h1 class="h3 mb-3">Generate Laporan Kapasitas Racip Kayu Bulat Hidup (Ton)</h1>
                <p class="text-secondary mb-4">
                    Laporan ini menggabungkan data dari stored procedure
                    <code>SP_KapasitasRacipKayuBulatHidup</code>,
                    <code>SP_KapasitasRacipKayuBulatHidupJmlhHK</code>,
                    <code>SP_KapasitasRacipKayuBulatHidupJmlhMeja</code>,
                    dan <code>SP_KapasitasRacipKayuBulatHidupKG</code>.
                </p>
                ...
                <form method="POST"
                    action="{{ route('reports.verifikasi.kapasitas-racip-kayu-bulat-hidup.download') }}"
                    class="row g-3">
                    @csrf
                    <div class="col-md-4">
                    ...
                    <div class="col-12">
                        <div class="d-flex gap-2 flex-wrap">
                            ...
                            <button type="button" id="previewJsonBtn" class="btn btn-outline-secondary">Preview
                                JSON</button>
                        </div>
                    </div>
                </form>
            ...
            previewButton.addEventListener('click', async function() {
                ...
                try {
                    const response = await fetch(
                        '{{ route('reports.verifikasi.kapasitas-racip-kayu-bulat-hidup.preview') }}', {
                            method: 'POST',
                            headers: {
