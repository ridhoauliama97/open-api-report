...
<head>
    ...
    <style>
        ...
        .money-table th,
        .money-table td,
        .rendemen-total-table th,
        .rendemen-total-table td,
        .report-table th,
        .report-table td,
        .summary-pair-table th,
        .summary-pair-table td,
        .summary-rendemen-table th,
                                                            ...
                                                            <tbody>
                                                                ...
                                                                @else
                                                                    @foreach ($balokRows as $bline)
                                                                        ...
                                                                        @if ($showBalokRow)
                                                                            <tr>
                                                                                <td class="{{ $isTotal ? 'label-total' : 'label' }}">
                                                                                    {{ $bLabel }}
                                                                                </td>
                                        ...
                                        <td class="diagram-side-cell">
                                            ...
                                            <table class="ringkasan-table" style="width:100%">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>Rendemen : <span
                                                                class="ringkasan-rendemen-highlight">{{ $fmtPercentTotal($rendemen, 1) }}</span>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                                {{-- <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="ringkasan-eq">&nbsp;</td>
                                                    <td class="ringkasan-value"><span class="ringkasan-rendemen-highlight">{{
                                                            $fmtPercentTotal($rendemen, 1) }}</span></td>
                                                </tr> --}}
                                                <tr>
                                                    <td class="ringkasan-formula">
                                                        Rendemen = (Total Output ST / KB) x 100% = ({{ $fmtTotal($stTotal, 4) }} /
                                                        {{ $fmtTotal($kbTotal, 4) }}) x 100% = {{ $fmtPercentTotal($rendemen, 1) }}
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                        ...
                        <div style="width: 100%; font-size: 11px; text-align: left;">
                            <table align="left"
                                ...
                                <tr>
                                    ...
                                    <td
                                        style="border: 0; padding: 0 0 2px 0; width: 35mm; font-weight: bold; text-align: right; white-space: nowrap; ">
                                        {{ $fmtMoney((float) ($grandMoneyBansaw['upah'] ?? 0.0)) }}
                                    </td>
                                    <td style="border: 0; padding: 0 0 2px 12px; width: 45mm;"></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td
                                        style="border: 0; padding: 0 0 2px 0; width: 35mm; font-weight: bold; text-align: right; white-space: nowrap; ">
                                        {{ $fmtMoney((float) ($grandMoneyBansaw['hasil'] ?? 0.0)) }}
                                    </td>
                                    <td
                                            ...
                                            <tbody>
                                                @foreach ($grandSummaryRows as $summaryRow)
                                                    <tr
                                                        ...
                                                        <td class="num">
                                                            {{ $fmtDetail((float) $summaryRow['kb'], 2) }}
                                                        </td>
                                                        <td class="num">
                                                            {{ $fmtDetail((float) $summaryRow['st'], 2) }}
                                                        </td>
                                                        <td class="num">
