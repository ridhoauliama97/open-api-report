    ...
    @php
        ...
        $formatHeaderLabel = static function (string $column) use ($normalize): string {
            return match ($normalize($column)) {
                ...
                'datecreate', 'tanggal' => 'Tanggal',
                'nmsupplier', 'namasupplier' => 'Nama Supplier',
                'notruk', 'truk', 'mtruk' => 'No Truk',
                'tonkbkg', 'ton', 'jmlhton', 'jumlahton', 'berat' => 'Berat Muatan (Ton)',
        ...
        $computeLamaTunggu = static function (array $row, string $groupName) use ($parseDateValue, $diffDays, $dateCreateColumn, $tanggalLamaRacipColumn, $dateUsageColumn, $tanggalRacipColumn, $modelColumn, $printedReportReference, ): ?int {
        ...
        @if ($groupName === 'Masih Hidup')
            ...
            <table class="group-note">
                <tr>
                    ...
                    <td class="center" style="width:23.33%">
                        Jmlh Sudah Masuk Meja : {{ number_format($sudahMasukMejaTon, 4, '.', ',') }} Ton
                    </td>
                    <td class="right" style="width:23.33%">
