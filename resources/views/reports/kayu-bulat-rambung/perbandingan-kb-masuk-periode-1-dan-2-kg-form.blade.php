...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Noto+Serif:ital,wght@0,100..900;1,100..900&display=swap"
        rel="stylesheet">
    <title>Generate Laporan Perbandingan KB Masuk Periode 1 dan 2 - Timbang KG</title>
    ...
    <main class="container py-5">
        <div class="card border-0 shadow-sm">
            <div class="card-body p-4 p-md-5">
                <h1 class="h3 mb-3">Laporan Perbanding KB Masuk Periode 1 dan 2 - Timbang KG (PDF)</h1>
                <p class="text-secondary mb-4">
                    Sistem akan mengambil data dari sp_LapPerbandinganKBMasukPeriode1dan2KG.
                </p>
                @if ($errors->any())
                ...
                <form method="POST"
                    action="{{ route('reports.kayu-bulat.perbandingan-kb-masuk-periode-1-dan-2-kg.download') }}"
                    class="row g-3">
                    @csrf
                    <div class="col-md-3">
                    ...
                    <div class="col-12">
                        <div class="d-flex gap-2 flex-wrap">
                            ...
                            <button type="submit" class="btn btn-outline-primary"
                                formaction="{{ route('reports.kayu-bulat.perbandingan-kb-masuk-periode-1-dan-2-kg.preview-pdf') }}"
                                formtarget="_blank">
                                Preview PDF
                            </button>
            ...
            previewButton.addEventListener('click', async function() {
                ...
                try {
                    const response = await fetch(
                        '{{ route('reports.kayu-bulat.perbandingan-kb-masuk-periode-1-dan-2-kg.preview') }}', {
                            method: 'POST',
                            headers: {
