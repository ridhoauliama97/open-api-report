...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Noto+Serif:ital,wght@0,100..900;1,100..900&display=swap"
        rel="stylesheet">
    <title>Generate Laporan Penerimaan Kayu Bulat Per Supplier Group</title>
    ...
    <main class="container py-5">
        <div class="card border-0 shadow-sm">
            <div class="card-body p-4 p-md-5">
                <h1 class="h3 mb-3">Generate Laporan Penerimaan Kayu Bulat Per-Supplier Berdasarkan Group Kayu (PDF)</h1>
                <p class="text-secondary mb-4">
                    Isi tanggal awal dan tanggal akhir, lalu sistem akan mengambil data dari
                    <code>SP_LapPenerimaanKBPerSupplierGroup</code>.
                    Output ditampilkan dalam format ringkasan per supplier dengan rasio per group kayu.
                </p>
                ...
                <form method="POST" action="{{ route('reports.kayu-bulat.penerimaan-per-supplier-group.download') }}"
                    class="row g-3">
                    @csrf
                    <div class="col-md-6">
            ...
            previewButton.addEventListener('click', async function() {
                ...
                try {
                    const response = await fetch(
                        '{{ route('reports.kayu-bulat.penerimaan-per-supplier-group.preview') }}', {
                            method: 'POST',
                            headers: {
