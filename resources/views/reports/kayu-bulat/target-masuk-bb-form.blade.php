...
<body class="bg-light">
    ...
    <main class="container py-5">
        <div class="card border-0 shadow-sm mb-4">
            <div class="card-body p-4 p-md-5">
                <h1 class="h3 mb-2">Laporan Target Masuk Bahan Baku Harian</h1>
                <p class="text-secondary mb-4">
                    Data diambil dari stored procedure <code>SP_LapTargetMasukBB</code> dengan susunan tabel di atas
                    dan chart harian di bawah.
                </p>
                ...
                <form method="GET" action="{{ route('reports.kayu-bulat.target-masuk-bb.index') }}" class="row g-3">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4 d-flex align-items-end gap-2">
                        ...
                        <a href="{{ route('reports.kayu-bulat.target-masuk-bb.download', ['start_date' => $startDate, 'end_date' => $endDate]) }}"
                            class="btn btn-success">Generate PDF</a>
                        <a href="{{ route('reports.kayu-bulat.target-masuk-bb.download', ['start_date' => $startDate, 'end_date' => $endDate, 'preview_pdf' => 1]) }}"
                            target="_blank" class="btn btn-outline-primary">Preview PDF</a>
                        <a href="{{ route('reports.kayu-bulat.target-masuk-bb.preview', ['start_date' => $startDate, 'end_date' => $endDate]) }}"
        ...
        <div class="card border-0 shadow-sm mb-4">
            <div class="card-body p-4">
                <h2 class="h6 text-center fw-bold mb-0">Laporan Target Masuk Bahan Baku Harian</h2>
                    ...
                    <table class="table report-table mb-0">
                        <thead>
                            <tr>
                                ...
                                <th
                                    colspan="{{ count($reportData['day_columns']) + count($reportData['lb_columns']) }}">
                                    Detail Target Harian
                                </th>
                                <th rowspan="2">Total</th>
                            </tr>
                            <tr>
                                @foreach ($reportData['day_columns'] as $dayMeta)
                                    <th>{{ $dayMeta['label'] }}</th>
                ...
                <div class="table-responsive mb-3" style="max-width: 240px;">
                ...
                <div style="height: 420px;">
                    <canvas id="targetMasukBbChart"></canvas>
                </div>
            </div>
        </div>
    </main>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const chartCanvas = document.getElementById('targetMasukBbChart');
            ...
            const datasets = jenisList.map((jenis, index) => ({
                label: jenis,
