...
<body>
    ...
    <h1 class="report-title">Laporan Penerimaan Kayu Bulat - (Ext Ton)</h1>
    ...
    <table class="signature-table">
        <tr class="signature-label-row">
            <td><div class="signature-label">Ukur 1 ;</div></td>
            <td><div class="signature-label">Ukur 2 ;</div></td>
            <td><div class="signature-label">Tally Tulis ;</div></td>
            <td><div class="signature-label">Diperiksa Oleh ;</div></td>
            <td><div class="signature-label">QC Oleh ;</div></td>
            <td><div class="signature-label">Diinput Oleh ;</div></td>
            <td><div class="signature-label">Supir ;</div></td>
        </tr>
