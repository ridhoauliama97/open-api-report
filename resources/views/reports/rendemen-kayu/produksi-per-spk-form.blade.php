...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Noto+Serif:ital,wght@0,100..900;1,100..900&display=swap"
        rel="stylesheet">
    <title>Generate Laporan Produksi Per SPK</title>
...
<body class="bg-light">
    ...
    <main class="container py-5">
        <div class="card border-0 shadow-sm">
            <div class="card-body p-4 p-md-5">
                <h1 class="h3 mb-3">Generate Laporan Produksi Per SPK (PDF)</h1>
                <p class="text-secondary mb-4">
                    Laporan ini mengambil data rendemen per group dari
                    <code>SP_LapProduksiPerSPK</code> dengan parameter <code>@NoSPK</code>, lalu
                    melengkapi header SPK dan label aktif dari data transaksi yang masih hidup.
                </p>
                @if ($errors->any())
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (!previewButton || !previewWrapper || !previewOutput || !noSpkInput) {
                return;
            }
            ...
            previewButton.addEventListener('click', async function() {
                ...
                try {
                    const response = await fetch('{{ route('reports.rendemen-kayu.produksi-per-spk.preview') }}', {
                        method: 'POST',
                        headers: {
