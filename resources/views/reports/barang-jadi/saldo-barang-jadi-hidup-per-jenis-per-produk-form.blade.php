...
<head>
    ...
    <title>Generate Laporan Saldo Barang Jadi Hidup Per-Jenis Per-Produk</title>
    ...
    <main class="container py-5">
        <div class="card border-0 shadow-sm">
            <div class="card-body p-4 p-md-5">
                <h1 class="h3 mb-3">Generate Laporan Saldo Barang Jadi Hidup Per-Jenis Per-Produk</h1>
                <p class="text-secondary mb-4">
                    Laporan ini tidak membutuhkan parameter. Sistem akan mengambil saldo hidup barang jadi langsung dari database
                    dan menyiapkan PDF.
                </p>
                ...
                <form method="POST" action="{{ route('reports.barang-jadi.saldo-barang-jadi-hidup-per-jenis-per-produk.download') }}" class="row g-3">
                    @csrf
                    <div class="col-12">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            previewButton.addEventListener('click', async function() {
                ...
                try {
                    const response = await fetch('{{ route('reports.barang-jadi.saldo-barang-jadi-hidup-per-jenis-per-produk.preview') }}', {
                        method: 'POST',
                        headers: {
