...
<head>
    ...
    <title>Generate Laporan Rekap Produksi Packing Consolidated</title>
    ...
    <main class="container py-5">
        <div class="card border-0 shadow-sm">
            <div class="card-body p-4 p-md-5">
                <h1 class="h3 mb-3">Generate Laporan Rekap Produksi Packing Consolidated</h1>
                <p class="text-secondary mb-4">Pilih periode laporan untuk generate PDF.</p>
                @if ($errors->any())
                ...
                @endif
                <form method="POST" action="{{ route('reports.barang-jadi.rekap-produksi-barang-jadi-consolidated.download') }}" class="row g-3">
                    @csrf
                    <div class="col-md-6">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            previewButton.addEventListener('click', async function() {
                ...
                try {
                    const response = await fetch('{{ route('reports.barang-jadi.rekap-produksi-barang-jadi-consolidated.preview') }}', {
                        method: 'POST',
                        headers: {
