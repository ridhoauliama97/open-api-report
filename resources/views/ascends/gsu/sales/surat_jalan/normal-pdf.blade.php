...
<body>
    @php
        ...
        $footerDocumentNumber = (string) ($documents[0]['document_number'] ?? '');
    ...
    @forelse ($documents as $document)
        @php
            ...
            $kirimName = (string) ($document['shipping_name'] ?? '' ?: $document['customer_name'] ?? '');
            $tanggalSuratJalan = (string) ($document['delivery_date'] ?? '');
        ...
        <div class="document-page {{ $loop->last ? '' : 'page-break-after' }}">
            <h1 class="report-title">Surat Jalan (GSU)</h1>
                    ...
                    <td class="top-block-left">
                        <table class="address-table">
                            ...
                            <tr>
                                ...
                                <td class="address-separator">:</td>
                                <td class="address-value">
                                    <span class="customer-name">&nbsp;{{ $kirimName }}</span>
                                    @if ($kirimAddress !== '')
                    ...
                    <td class="top-block-right">
                        <table class="invoice-info-table">
                            ...
                            <tr>
                                ...
                                <td class="invoice-info-separator">:</td>
                                <td class="invoice-info-value right">{{ $tanggalSuratJalan }}</td>
                            </tr>
                            <tr>
            ...
            <table class="signature-table">
                ...
                <tr class="signature-subhead">
                    <td style="width: 25%;">Checker</td>
                    <td style="width: 25%;">Ka. Div Gudang</td>
                    <td style="width: 25%;">Supir/Kernet</td>
                ...
                <tr>
                    ...
                    <td></td>
                    <td>
                        <table class="signature-note">
                            <tr>
                                <td><small>No. Mobil :</small></td>
                            </tr>
                        </table>
                    </td>
                    <td></td>
    ...
    <div class="middle-page-footer">
        <table class="footer-laporan">
            <tr>
                ...
                {{-- <td width="34%" align="center">{{ $footerDocumentNumber }}</td> --}}
