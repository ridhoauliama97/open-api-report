...
<body>
    ...
    @forelse ($invoices as $invoice)
        @php
            ...
            $kirimName = (string) ($invoice["shipping_name"] ?? "" ?: $invoice["customer_name"] ?? "");
        ...
        <div class="invoice-page {{ $loop->last ? "" : "page-break-after" }}">
            <h1 class="report-title">Sales Invoices (GSU)</h1>
            ...
            <table class="bottom-grid">
                ...
                <tr>
                    <td class="bottom-block-left" style="vertical-align: top;">
                        ...
                        <div class="payment-note">
                            <p class="payment-note-title">
                                Pembayaran wajib melalui transfer ke salah satu rekening perusahaan yaitu :
                            </p>
                            <ul class="payment-note-list">
                                <li>No. Rek BANK BCA : 383-141-1218 a/n Netty Pasaribu</li>
                                <li>No. Rek BANK MANDIRI : 106-0022-885-886 a/n Netty Pasaribu</li>
                            </ul>
                            <p class="payment-note-footnote">
                                *Invoice ini hanya berlaku apabila disertai dengan bukti pembayaran yang sah
                            </p>
                        </div>
                        {{-- <p class="keterangan-value">“{{ (string) ($invoice["remarks"] ?? "") }}.”</p> --}}
                    </td>
                    <td class="bottom-block-middle" style="vertical-align: top;"></td>
                    <td class="bottom-block-right" style="vertical-align: top;">
    ...
    <htmlpagefooter name="reportFooter">
        <table class="footer-laporan">
            <tr>
                ...
                <td width="33%" align="center">{{ (string) ($invoice["invoice_number"] ?? "") }}</td>
