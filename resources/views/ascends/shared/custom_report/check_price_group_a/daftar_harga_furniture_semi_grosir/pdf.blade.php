...
<body>
    @php
        ...
        $headerTitle = trim((string) ($reportData['title'] ?? 'DAFTAR HARGA FURNITURE SEMI GROSIR'));
                ...
                <table class="data-table">
                    <thead>
                        <tr>
                            ...
                            <th style="width: 15%;">Harga Konsumen</th>
                            <th style="width: 15%;">Semi Grosir<br>Diskon 7%</th>
                        </tr>
                    </thead>
                    <tbody>
            @endif
