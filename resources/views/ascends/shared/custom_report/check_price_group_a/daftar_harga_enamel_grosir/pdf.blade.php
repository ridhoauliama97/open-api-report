...
<body>
    ...
    <p class="report-subtitle">Harga Grosir</p>
        ...
        <table class="data-table">
            <thead>
                <tr>
                    ...
                    <th style="width: 16%;">Grosir<br>7 %</th>
                </tr>
            </thead>
            <tbody>
                @foreach ($items as $idx => $item)
                    ...
                    <tr class="{{ $rowNo % 2 === 0 ? 'row-even' : 'row-odd' }}">
                        ...
                        <td class="number">{{ fmtNum($item['grosir'] ?? 0) }}</td>
                    </tr>
                @endforeach
            </tbody>
        </table>
    ...
    <div class="notes-section">
        <ol>
            ...
            <li>Dengan berlakunya Price List ini maka Price List sebelumnya tidak berlaku lagi</li>
