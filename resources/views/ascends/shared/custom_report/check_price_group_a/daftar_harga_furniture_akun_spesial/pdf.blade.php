...
<body>
    ...
    @endif
    <h1 class="report-title">DAFTAR HARGA FURNITURE</h1>
                ...
                <table class="data-table">
                    <thead>
                        <tr>
                            ...
                            <th style="width: 12%;">{{ $item['ket'] }}</th>
                            <th style="width: 19%;">Harga<br>Konsumen</th>
                            <th style="width: 19%;">Akun Spesial<br>Diskon 11%</th>
                        </tr>
                    </thead>
                    <tbody>
            @endif
                    ...
                    <tr class="{{ $rowNo % 2 === 0 ? 'row-even' : 'row-odd' }}">
                        ...
                        <td class="center">{{ fmtPerDus($item['per_dus']) }}</td>
            ...
            <tbody>
                <tr>
                    <td class="center" style="font-style: italic; padding: 10px;">
                        Tidak ada data daftar harga furniture akun spesial.
                    </td>
                </tr>
            </tbody>
        </table>
