    ...
    <table class="data-table">
        <thead>
            <tr>
                ...
                <th style="width: 28%;">Nama Customer</th>
                <th style="width: 22%;">Salesman</th>
        ...
        <tbody>
            ...
            @empty
                <tr>
                    <td colspan="7" class="center" style="font-style: italic; padding: 10px 2px;">
                        Tidak ada data.
                    </td>
                </tr>
            @endforelse
            <tr class="grand-row">
                <td colspan="7">Grand Total : {{ $totalRows }}</td>
            </tr>
        </tbody>
    </table>
