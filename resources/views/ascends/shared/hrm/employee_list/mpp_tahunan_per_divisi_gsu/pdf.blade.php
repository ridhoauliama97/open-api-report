...
<body>
    ...
    @forelse ($yearlyRows as $yearData)
        @if (!$loop->first)
        ...
        <table class="data-table">
            <thead>
                <tr>
                    ...
                    <th style="width: 8%;">MPP<br>Karyawan</th>
                    <th style="width: 9%;">Karyawan<br>Masuk</th>
                    <th style="width: 8%;">Masuk<br>(%)</th>
                    <th style="width: 9%;">Karyawan<br>Keluar</th>
                    <th style="width: 8%;">Keluar<br>(%)</th>
                    <th style="width: 9%;">Total<br>Karyawan</th>
                    <th style="width: 8%;">Total<br>(%)</th>
                    <th style="width: 7%;">GAP</th>
                    <th style="width: 8%;">GAP<br>(%)</th>
            ...
            <tbody>
                @foreach (($yearData['rows'] ?? []) as $row)
                    <tr class="{{ $loop->odd ? 'row-odd' : 'row-even' }}">
                        ...
                        <td class="center">{{ (int) ($row['MPP Karyawan'] ?? 0) }}</td>
                        <td class="center">{{ (int) ($row['Karyawan Masuk'] ?? 0) }}</td>
                        <td class="center nowrap">{{ (string) ($row['Karyawan Masuk (%)'] ?? '0.0%') }}</td>
                        <td class="center">{{ (int) ($row['Karyawan Keluar'] ?? 0) }}</td>
                        <td class="center nowrap">{{ (string) ($row['Karyawan Keluar (%)'] ?? '0.0%') }}</td>
                        <td class="center">{{ (int) ($row['Total Karyawan'] ?? 0) }}</td>
                        <td class="center nowrap">{{ (string) ($row['Total Karyawan (%)'] ?? '0.0%') }}</td>
