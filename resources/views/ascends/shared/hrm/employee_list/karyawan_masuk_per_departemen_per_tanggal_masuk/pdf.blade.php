...
<body>
    @php
        ...
        $company = strtoupper(trim((string) ($company ?? $reportData['company'] ?? '')));
    ...
    <table class="data-table">
        <thead>
            <tr>
                ...
                <th style="width: 17%;">Pendidikan<br>Terakhir</th>
                <th style="width: 15%;">Tanggal<br>Masuk</th>
            </tr>
        </thead>
        <tbody>
            @forelse ($groupedRows as $department)
                ...
                <tr class="department-row">
                    <td colspan="8">{{ $department['label'] ?? '' }}</td>
                </tr>
                    ...
                    <td colspan="8">
                        <table class="summary-table">
                            ...
                            @foreach ($summaryPairs($summaryItems($summary['education'] ?? [])) as $pair)
                                <tr>
                                    <td class="summary-label">{{ $loop->first ? 'Akumulasi Pendidikan' : '' }}</td>
                                    <td class="summary-separator">{{ $loop->first ? ':' : '' }}</td>
                                    <td class="summary-value">{{ $formatSummaryItem($pair[0]) }}</td>
                                    <td class="summary-value">{{ $formatSummaryItem($pair[1]) }}</td>
                                </tr>
                ...
                <td colspan="8">
                    <table class="summary-table">
                        <tr>
                            ...
                            <td class="summary-separator">:</td>
                            <td colspan="2">{{ (int) ($grandSummary['subtotal'] ?? $reportData['total_rows'] ?? 0) }}</td>
                        </tr>
