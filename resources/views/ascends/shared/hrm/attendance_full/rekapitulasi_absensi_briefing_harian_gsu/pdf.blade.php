    ...
    <table class="data-table">
        <thead>
            <tr>
                ...
                <th style="width: 12%;">Jumlah<br>Telat</th>
                <th style="width: 12%;">Jumlah<br>Tidak Hadir</th>
                <th style="width: 18%;">Jumlah Saat<br>Pukul 15.00<br>WIB</th>
        ...
        <tbody>
            @forelse ($rows as $row)
                <tr class="{{ $loop->odd ? 'row-odd' : 'row-even' }}">
                    ...
                    <td class="center">{{ (string) ($row['Jumlah Saat Pukul 15.00 Wib'] ?? '') }}</td>
            ...
            <tr class="grand-row">
                ...
                <td class="center">{{ (string) ($grandSummary['Jumlah Saat Pukul 15.00 Wib'] ?? '') }}</td>
