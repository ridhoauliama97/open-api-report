...
<body>
    ...
    <h1 class="report-title">Laporan Karyawan Aktif Per Departemen (UC)</h1>
    ...
    <table class="data-table">
        <thead>
            <tr>
                ...
                <th style="width: 13%;">Pendidikan<br>Terakhir</th>
                <th style="width: 18%;">Tanggal<br>Masuk</th>
            </tr>
        </thead>
        <tbody>
            @forelse ($groupedRows as $group)
                ...
                @foreach ($groupRows as $row)
                    <tr class="{{ $loop->odd ? 'row-odd' : 'row-even' }}">
                        ...
                        <td class="center">{{ (string) ($row['Strata Pend'] ?? '') }}</td>
