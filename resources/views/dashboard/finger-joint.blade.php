    ...
    <main class="container py-5">
        <div class="card border-0 shadow-sm mb-4">
            <div class="card-body p-4 p-md-5">
                <h1 class="h3 mb-2">Laporan Dashboard Finger Joint</h1>
                <p class="text-secondary mb-4">
                    Visualisasi arus masuk dan keluar harian per grade berdasarkan
                    <code>SPWps_LapDashboardFJ</code>.
                </p>
                ...
                <form method="GET" action="{{ route('dashboard.finger-joint.index') }}" class="row g-3">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4 d-flex align-items-end gap-2">
                        ...
                        <a href="{{ route('dashboard.finger-joint.download', ['start_date' => $startDate, 'end_date' => $endDate]) }}"
                            class="btn btn-success">Generate PDF</a>
                        <a href="{{ route('dashboard.finger-joint.download', ['start_date' => $startDate, 'end_date' => $endDate, 'preview_pdf' => 1]) }}"
                            class="btn btn-outline-primary" target="_blank">Preview PDF</a>
                        <a href="{{ route('dashboard.finger-joint.preview', ['start_date' => $startDate, 'end_date' => $endDate]) }}"
