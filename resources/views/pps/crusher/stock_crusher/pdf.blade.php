...
<body>
    @php
        ...
        $headerLabels = [
            'DateCreate' => 'Tanggal',
            'NoCrusher' => 'No Crusher',
            'NamaCrusher' => 'Nama Crusher',
            'NamaWarehouse' => 'Nama Warehouse',
            'Blok' => 'Lokasi',
            'Berat' => 'Berat (Kg)',
        ];
        $centerColumns = ['DateCreate', 'NoCrusher', 'NamaWarehouse', 'Blok'];
        $preferredOrder = ['DateCreate', 'NoCrusher', 'NamaCrusher', 'NamaWarehouse', 'Blok', 'Berat'];
