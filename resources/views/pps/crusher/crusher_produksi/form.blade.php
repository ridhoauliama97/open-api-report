...
<head>
    ...
    <title>Generate Laporan Harian Hasil Crusher Produksi</title>
    ...
    <main class="container py-5">
        <div class="card border-0 shadow-sm">
            <div class="card-body p-4 p-md-5">
                <h1 class="h3 mb-3">Generate Laporan Harian Hasil Crusher Produksi (PPS)</h1>
                <p class="text-secondary mb-4">Sumber data utama: stored procedure <code>SP_LapHasilProduksiHarianCrusher</code> pada database PPS.</p>
                ...
                <form method="POST" action="{{ route('reports.pps.crusher.crusher-produksi.download') }}" class="row g-3">
                    @csrf
                    <div class="col-md-7">
                        <label for="no_produksi" class="form-label">No Crusher Produksi</label>
                        <input type="text" id="no_produksi" name="no_produksi" class="form-control" required list="recentNoProduksiList" value="{{ old('no_produksi') }}" placeholder="Contoh: G.0000000701">
                ...
                @if (!empty($recentNoProduksi))
                    <div class="mt-4">
                        <h2 class="h6 mb-2">No Crusher Produksi Terbaru</h2>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            previewButton.addEventListener('click', async function () {
                ...
                try {
                    const response = await fetch('{{ route('reports.pps.crusher.crusher-produksi.preview') }}', {
                        method: 'POST',
                        headers: {
