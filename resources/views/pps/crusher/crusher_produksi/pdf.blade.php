...
<body>
    @php
        ...
        $outputNameOrFallback = static function (array $row) use ($textOrBlank): string {
            ...
            $hasOutputContext = trim((string) ($row['output_nomor_label'] ?? '')) !== ''
            ...
            @foreach ($detailRows as $row)
                <tr class="data-row {{ $loop->odd ? 'row-odd' : 'row-even' }}">
                    ...
                    <td class="data-cell center">
                        {!! $textOrBlank($row['output_hasil_cek_qc'] ?? '') !!}</td>
        ...
        <table class="signature-table">
            ...
            <thead>
                ...
                <tr>
                    ...
                    <th class="signature-role">Ka. Regu Crusher</th>
                    <th class="signature-role">Ka. Div, Crusher</th>
                ...
                <tr>
                    ...
                    <td class="signature-span-cell" rowspan="3">
                        <table class="signature-inner">
                            ...
                            <tr>
                                <td class="signature-inner-name">{!! ($approvals['ka_regu_crusher'] ?? '') !== '' ? e($approvals['ka_regu_crusher']) : '&nbsp;' !!}</td>
                            </tr>
                        </table>
                    </td>
                    <td class="signature-span-cell" rowspan="3">
                        <table class="signature-inner">
                            ...
                            <tr>
                                <td class="signature-inner-name">{!! ($approvals['ka_div_crusher'] ?? '') !== '' ? e($approvals['ka_div_crusher']) : '&nbsp;' !!}</td>
                            </tr>
                        </table>
                    </td>
                    <td class="signature-span-cell" rowspan="3">
