...
<head>
    ...
    <title>Generate Laporan Stock Furniture WIP</title>
    ...
    <main class="container py-5">
        <div class="card border-0 shadow-sm">
            <div class="card-body p-4 p-md-5">
                <h1 class="h3 mb-3">Generate Laporan Stock Furniture WIP (PPS)</h1>
                <p class="text-secondary mb-4">
                    Sumber data: stored procedure <code>SP_LapStokFurnitureWIPV2</code>.
                ...
                <form method="POST" action="{{ route('reports.pps.furniture-wip.stock-furniture-wip-v2.download') }}"
                    class="row g-3">
                    @csrf
                    <div class="col-md-6">
            ...
            previewButton.addEventListener('click', async function() {
                ...
                try {
                    const response = await fetch(
                        '{{ route('reports.pps.furniture-wip.stock-furniture-wip-v2.preview') }}', {
                            method: 'POST',
                            headers: {
