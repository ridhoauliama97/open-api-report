...
<head>
    ...
    <title>Generate Laporan Rekap Produksi Inject BJ</title>
    ...
    <main class="container py-5">
        <div class="card border-0 shadow-sm">
            <div class="card-body p-4 p-md-5">
                <h1 class="h3 mb-3">Generate Laporan Produksi Harian - Inject BJ (PPS)</h1>
                <p class="text-secondary mb-4">
                    Sumber data: stored procedure <code>SP_LapRekapProduksiInject_BJ</code> pada database PPS.
                </p>
                ...
                <form method="POST" action="{{ route('reports.pps.rekap-produksi.inject-bj.download') }}" class="row g-3">
                    @csrf
                    <div class="col-md-6">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            previewButton.addEventListener('click', async function() {
                ...
                try {
                    const response = await fetch('{{ route('reports.pps.rekap-produksi.inject-bj.preview') }}', {
                        method: 'POST',
                        headers: {
