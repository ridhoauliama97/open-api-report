...
<head>
    ...
    <title>Generate Laporan Produksi Harian - Pasang Kunci (FWIP)</title>
    ...
    <main class="container py-5">
        <div class="card border-0 shadow-sm">
            <div class="card-body p-4 p-md-5">
                <h1 class="h3 mb-3">Generate Laporan Produksi Harian - Pasang Kunci (FWIP)</h1>
                <p class="text-secondary mb-4">
                    Sumber data: stored procedure <code>SP_LapRekapProduksiPKunci_FWIP</code> pada database PPS.
                </p>
                ...
                <form method="POST" action="{{ route('reports.pps.rekap-produksi.pasang-kunci-fwip.download') }}" class="row g-3">
                    @csrf
                    <div class="col-md-6">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            previewButton.addEventListener('click', async function() {
                ...
                try {
                    const response = await fetch('{{ route('reports.pps.rekap-produksi.pasang-kunci-fwip.preview') }}', {
                        method: 'POST',
                        headers: {
