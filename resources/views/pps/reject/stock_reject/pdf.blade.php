...
<body>
    @php
        ...
        $centerColumns = ['DateCreate', 'NoReject', 'NamaWarehouse', 'Blok'];
        $preferredOrder = ['DateCreate', 'NoReject', 'NamaReject', 'NamaWarehouse', 'Blok', 'Berat'];
        ...
        $displayValue = static function (array $row, string $column) {
            ...
            if ($column === 'Blok') {
                ...
                return $blok !== '' && $idLokasi !== '' ? "{$blok} - {$idLokasi}" : '';
            }
        ...
        <thead>
            <tr>
                ...
                @foreach ($visibleColumns as $column)
                    <th @if (isset($columnWidths[$column])) style="width: {{ $columnWidths[$column] }};" @endif>
