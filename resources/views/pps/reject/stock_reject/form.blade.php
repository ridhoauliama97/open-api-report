...
<head>
    ...
    <title>Generate Laporan Stock Reject</title>
    ...
    <main class="container py-5">
        <div class="card border-0 shadow-sm">
            <div class="card-body p-4 p-md-5">
                <h1 class="h3 mb-3">Generate Laporan Stock Reject (PPS)</h1>
                <p class="text-secondary mb-4">
                    Sumber data: stored procedure <code>SP_LaporanStockLabelReject</code>.
                ...
                <form method="POST" action="{{ route('reports.pps.reject.stock-reject.download') }}" class="row g-3">
                    @csrf
                    <div class="col-md-6">
            ...
            previewButton.addEventListener('click', async function() {
                ...
                try {
                    const response = await fetch(
                        '{{ route('reports.pps.reject.stock-reject.preview') }}', {
                            method: 'POST',
                            headers: {
