...
<body>
    ...
    <h1 class="report-title">Laporan Harian Hasil Pasang Kunci Produksi</h1>
    ...
    <table class="report-table">
        <thead>
            <tr>
                ...
                <th colspan="4">Hasil Pasang Kunci</th>
                ...
                <tr>
                    ...
                    <td class="signature-span-cell" rowspan="3">
                        <table class="signature-inner">
                            ...
                            <tr>
                                <td class="signature-inner-name">
                                    {!! ($approvals['ka_regu_pasang_kunci'] ?? '') !== '' ? e($approvals['ka_regu_pasang_kunci']) : '&nbsp;' !!}
                                </td>
                            </tr>
                        </table>
                    </td>
                    <td class="signature-span-cell" rowspan="3">
                        <table class="signature-inner">
                            ...
                            <tr>
                                <td class="signature-inner-name">
                                    {!! ($approvals['ka_div_pasang_kunci'] ?? '') !== '' ? e($approvals['ka_div_pasang_kunci']) : '&nbsp;' !!}
                                </td>
                            </tr>
                        </table>
                    </td>
