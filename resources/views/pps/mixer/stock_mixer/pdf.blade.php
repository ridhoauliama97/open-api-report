...
<body>
    @php
        ...
        $centerColumns = ['DateCreate', 'NoMixer', 'NamaWarehouse', 'Blok'];
        $preferredOrder = ['DateCreate', 'NoMixer', 'Jenis', 'NamaWarehouse', 'Blok', 'JmlhSak', 'Berat'];
    ...
    <h1 class="report-title">Laporan Stock Mixer</h1>
