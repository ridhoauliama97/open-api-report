        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body p-4 p-md-5">
                ...
                <p class="text-secondary mb-4">
                    Sumber data: stored procedure <code>SP_LaporanStockLabelGilingan</code>.
                ...
                <form method="POST" action="{{ route('reports.pps.gilingan.stock-gilingan.download') }}"
                    class="row g-3">
                    @csrf
                    <div class="col-md-6">
            ...
            previewButton.addEventListener('click', async function() {
                ...
                try {
                    const response = await fetch(
                        '{{ route('reports.pps.gilingan.stock-gilingan.preview') }}', {
                            method: 'POST',
                            headers: {
