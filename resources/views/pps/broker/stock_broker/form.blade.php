        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body p-4 p-md-5">
                ...
                <p class="text-secondary mb-4">
                    Sumber data: stored procedure <code>SP_LaporanStockLabelBroker</code>.
                ...
                <form method="POST" action="{{ route('reports.pps.broker.stock-broker.download') }}" class="row g-3">
                    @csrf
                    <div class="col-md-6">
            ...
            previewButton.addEventListener('click', async function() {
                ...
                try {
                    const response = await fetch(
                        '{{ route('reports.pps.broker.stock-broker.preview') }}', {
                            method: 'POST',
                            headers: {
