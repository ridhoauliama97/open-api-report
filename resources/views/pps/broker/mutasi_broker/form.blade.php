...
<head>
    ...
    <title>Generate Laporan Mutasi Broker PPS</title>
    ...
    <main class="container py-5">
        <div class="card border-0 shadow-sm">
            <div class="card-body p-4 p-md-5">
                <h1 class="h3 mb-3">Generate Laporan Mutasi Broker (PPS)</h1>
                <p class="text-secondary mb-4">
                    Isi tanggal awal dan tanggal akhir, lalu sistem akan mengambil data dari
                    <code>SP_PPSLapMutasiBroker</code>, <code>SP_PPSLapSubMutasiBroker</code>, dan
                    <code>SP_PPSLapWasteMutasiBroker</code> untuk menghasilkan file PDF.
                </p>
                @if ($errors->any())
                ...
                <form method="POST" action="{{ route('reports.pps.broker.mutasi-broker.download') }}" class="row g-3">
                    @csrf
                    <div class="col-md-6">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            previewButton.addEventListener('click', async function() {
                ...
                try {
                    const response = await fetch('{{ route('reports.pps.broker.mutasi-broker.preview') }}', {
                        method: 'POST',
                        headers: {
