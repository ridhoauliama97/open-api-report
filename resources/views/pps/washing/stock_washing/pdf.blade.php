...
<body>
    @php
        ...
        $centerColumns = ['DateCreate', 'NoWashing', 'NamaWarehouse', 'Blok'];
        $preferredOrder = ['DateCreate', 'NoWashing', 'Jenis', 'NamaWarehouse', 'Blok', 'JmlhSak', 'Berat'];
                ...
                <tr class="{{ $loop->odd ? 'row-odd' : 'row-even' }}">
                    ...
                    @foreach ($visibleColumns as $column)
                        @php
                            ...
                            $numericValue = $toFloat($row[$column] ?? null);
