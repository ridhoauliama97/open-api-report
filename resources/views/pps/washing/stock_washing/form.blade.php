        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body p-4 p-md-5">
                ...
                <p class="text-secondary mb-4">
                    Sumber data: stored procedure <code>SP_LaporanStockLabelWashing</code>.
                ...
                <form method="POST" action="{{ route('reports.pps.washing.stock-washing.download') }}" class="row g-3">
                    @csrf
                    <div class="col-md-6">
            ...
            previewButton.addEventListener('click', async function() {
                ...
                try {
                    const response = await fetch(
                        '{{ route('reports.pps.washing.stock-washing.preview') }}', {
                            method: 'POST',
                            headers: {
