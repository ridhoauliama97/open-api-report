...
<head>
    ...
    <title>Generate Laporan Harian Hasil Washing Produksi</title>
    ...
    <main class="container py-5">
        <div class="card border-0 shadow-sm">
            <div class="card-body p-4 p-md-5">
                <h1 class="h3 mb-3">Generate Laporan Harian Hasil Washing Produksi (PPS)</h1>
                <p class="text-secondary mb-4">Sumber data: stored procedure <code>SP_LapHasilProduksiHarianWashing</code> pada database PPS.</p>
                ...
                <form method="POST" action="{{ route('reports.pps.washing.washing-produksi.download') }}" class="row g-3">
                    @csrf
                    <div class="col-md-7">
                        ...
                        <input
                            ...
                            class="form-control"
                            required
                            list="recentNoProduksiList"
                            value="{{ old('no_produksi') }}"
                            placeholder="Contoh: C.0000002823"
                        >
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            previewButton.addEventListener('click', async function () {
                ...
                try {
                    const response = await fetch('{{ route('reports.pps.washing.washing-produksi.preview') }}', {
                        method: 'POST',
                        headers: {
