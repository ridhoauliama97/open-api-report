...
<body>
    ...
    <p class="report-subtitle">No Produksi: {{ $meta['no_produksi'] ?? '' }}</p>
                ...
                <tr>
                    <td class="signature-span-cell" rowspan="3">
                        <table class="signature-inner">
                            <tr><td class="signature-inner-space">&nbsp;</td></tr>
                            <tr><td class="signature-inner-name">{{ $approvals['operator'] !== '' ? $approvals['operator'] : '&nbsp;' }}</td></tr>
                        </table>
                    </td>
                    <td class="signature-span-cell" rowspan="3">
                        <table class="signature-inner">
                            <tr><td class="signature-inner-space">&nbsp;</td></tr>
                            <tr><td class="signature-inner-name">{!! ($approvals['ka_regu_cuci'] ?? '') !== '' ? e($approvals['ka_regu_cuci']) : '&nbsp;' !!}</td></tr>
                        </table>
                    </td>
                    <td class="signature-span-cell" rowspan="3">
                        <table class="signature-inner">
                            <tr><td class="signature-inner-space">&nbsp;</td></tr>
                            <tr><td class="signature-inner-name">{!! ($approvals['ka_div_cuci_broker'] ?? '') !== '' ? e($approvals['ka_div_cuci_broker']) : '&nbsp;' !!}</td></tr>
                        </table>
                    </td>
                    <td class="signature-span-cell" rowspan="3">
                        <table class="signature-inner">
                            <tr><td class="signature-inner-space">&nbsp;</td></tr>
                            <tr><td class="signature-inner-name">{!! ($approvals['ka_dept_produksi'] ?? '') !== '' ? e($approvals['ka_dept_produksi']) : '&nbsp;' !!}</td></tr>
                        </table>
                    </td>
