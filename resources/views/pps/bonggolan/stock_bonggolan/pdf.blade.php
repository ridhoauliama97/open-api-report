...
<body>
    @php
        ...
        $headerLabels = [
            'DateCreate' => 'Tanggal',
            'NoBonggolan' => 'No Bonggolan',
            'NamaBonggolan' => 'Jenis Plastik',
            'Berat' => 'Berat (Kg)',
            'NamaWarehouse' => 'Nama Warehouse',
            'Blok' => 'Lokasi',
        ];
        $centerColumns = ['DateCreate', 'NoBonggolan', 'NamaWarehouse', 'Blok'];
        $preferredOrder = ['DateCreate', 'NoBonggolan', 'NamaBonggolan', 'NamaWarehouse', 'Blok', 'Berat'];
            ...
            @empty
                <tr class="row-odd">
                    <td colspan="{{ count($visibleColumns) + 1 }}" class="center"
                        style="font-weight: bold; font-size: 11px; font-style: italic;">Tidak ada
                        data.</td>
                </tr>
            @endforelse
