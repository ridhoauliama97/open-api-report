...
<head>
    ...
    <title>Generate Laporan Stok Bonggolan</title>
    ...
    <main class="container py-5">
        <div class="card border-0 shadow-sm">
            <div class="card-body p-4 p-md-5">
                <h1 class="h3 mb-3">Generate Laporan Stok Bonggolan (PPS)</h1>
                <p class="text-secondary mb-4">
                    Sumber data: stored procedure <code>SP_LapStokBonggolanV2</code>.
                ...
                <form method="POST" action="{{ route('reports.pps.bonggolan.stock-bonggolan-v2.download') }}"
                    class="row g-3">
                    @csrf
                    <div class="col-md-6">
            ...
            previewButton.addEventListener('click', async function() {
                ...
                try {
                    const response = await fetch(
                        '{{ route('reports.pps.bonggolan.stock-bonggolan-v2.preview') }}', {
                            method: 'POST',
                            headers: {
