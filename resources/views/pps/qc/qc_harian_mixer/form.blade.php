...
<head>
    ...
    <title>Generate Laporan QC Harian Mixer</title>
    ...
    <main class="container py-5">
        <div class="card border-0 shadow-sm">
            <div class="card-body p-4 p-md-5">
                <h1 class="h3 mb-3">Generate Laporan QC Harian Mixer (PPS)</h1>
                <p class="text-secondary mb-4">
                    Sumber data: stored procedure <code>SP_LaporanHasilQCHarianMixer</code>.
                    Input report menggunakan <code>EndDate</code>, lalu sistem akan mengambil hasil QC harian mixer
                ...
                <form method="POST" action="{{ route('reports.pps.qc.qc-harian-mixer.download') }}" class="row g-3">
                    @csrf
                    <div class="col-md-6">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            previewButton.addEventListener('click', async function() {
                ...
                try {
                    const response = await fetch('{{ route('reports.pps.qc.qc-harian-mixer.preview') }}', {
                        method: 'POST',
                        headers: {
