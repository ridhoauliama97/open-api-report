...
<head>
    ...
    <title>Generate Laporan Semua Label</title>
    ...
    <main class="container py-5">
        <div class="card border-0 shadow-sm">
            <div class="card-body p-4 p-md-5">
                <h1 class="h3 mb-3">Generate Laporan Semua Label (PPS)</h1>
                <p class="text-secondary mb-4">
                    Sumber data: stored procedure <code>SP_LaporanSemuaLabel</code> pada database PPS tanpa parameter.
                </p>
                ...
                <form method="POST" action="{{ route('reports.pps.semua-label.download') }}" class="row g-3">
                    @csrf
                    <div class="col-12">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            previewButton.addEventListener('click', async function() {
                ...
                try {
                    const response = await fetch('{{ route('reports.pps.semua-label.preview') }}', {
                        method: 'POST',
                        headers: {
